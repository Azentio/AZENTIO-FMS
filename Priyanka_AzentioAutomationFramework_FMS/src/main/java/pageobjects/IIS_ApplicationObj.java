...
//	@AT_IC_010
	...
	private WebElement IIS_serverwarning_popup_ok_btn;
	public WebElement IIS_serverwarning_popup_ok_btn(){
		return IIS_serverwarning_popup_ok_btn;
	}
	@FindBy(xpath = "//input[@id='_popup_path_sol_confirm_ok']")
	...
	@FindBy(xpath = "//input[@id='_popup_path_sol_confirm_ok']")
	private WebElement IIS_success_popup_ok_btnn;
	public WebElement IIS_SuccessPopupOkBtnn(){
		return IIS_success_popup_ok_btnn;
	}
	@FindBy(xpath = "//input[@id='_popup_path_sol_ok']")
...
//	Reschedule Repayment Plan module
	...
	@FindBy(xpath = "//td[contains(text(),'Advance Principal Settlement')]")
	private WebElement IIS_Advance_Principal_Settlement_Menu;
	public WebElement IIS_Advance_Principal_Settlement_Menu() {
		return IIS_Advance_Principal_Settlement_Menu;

	}
	
	@FindBy(xpath = "//a[@id='T036MT']")
	private WebElement IIS_Advance_Principal_Settlement_MaintenanceMenu;
	public WebElement IIS_Advance_Principal_Settlement_MaintenanceMenu() {
		return IIS_Advance_Principal_Settlement_MaintenanceMenu;

	}
	@FindBy(xpath = "//input[@id='lookuptxt_dealNo_T036MT']")
	private WebElement IIS_Advance_Principal_Settlement_Maintenance_DealNbr_Input;
	public WebElement IIS_Advance_Principal_Settlement_Maintenance_DealNbr_Input() {
		return IIS_Advance_Principal_Settlement_Maintenance_DealNbr_Input;

	}
	
	@FindBy(xpath = "//li[@id='settlementTab2_T036MT']")
	private WebElement IIS_Advance_Principal_Settlement_Maintenance_ScheduleDetails_Tab;
	public WebElement IIS_Advance_Principal_Settlement_Maintenance_ScheduleDetails_Tab() {
		return IIS_Advance_Principal_Settlement_Maintenance_ScheduleDetails_Tab;

	}
	
	@FindBy(xpath = "//td[@id='td_settlementScheduleGridTbl_Id_T036MT_1_trssetlmtdetvo.PAYMENT_DATE']")
	private WebElement IIS_Advance_Principal_Settlement_Maintenance_PaymentDate;
	public WebElement IIS_Advance_Principal_Settlement_Maintenance_PaymentDate() {
		return IIS_Advance_Principal_Settlement_Maintenance_PaymentDate;
