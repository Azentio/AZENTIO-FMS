...
public class MTS_Login {
	public MTS_Login(WebDriver driver) {
		this.driver=driver;
	}
	WebDriver driver;
	FMSCommonWebElements fmsCommonWebElements;
	String TestDataPath = System.getProperty("user.dir") + "\\TestData\\FMSTestData.xlsx";
	ExcelData MTS_LoginExceldata = new ExcelData(TestDataPath, "MTS_Login", "UserType");
	Map<String, String> MTS_LoginTestData = new HashMap<>();
	WaitHelper waitHelper = new WaitHelper(driver);
	ClicksAndActionsHelper clicksAndActionHelper;
	public void loginIntoMTSApplication(String userType) {
		MTS_LoginTestData = MTS_LoginExceldata.getTestdata(userType);
		...
		fmsCommonWebElements.fmsUserName().sendKeys(MTS_LoginTestData.get("UserName"));
		waitHelper.waitForElementwithFluentwait(driver, fmsCommonWebElements.fmsPassword());
		fmsCommonWebElements.fmsPassword().click();
		fmsCommonWebElements.fmsPassword().sendKeys(MTS_LoginTestData.get("Password"));
		...
		fmsCommonWebElements.fmsCompanyCode().sendKeys(MTS_LoginTestData.get("CompanyCode"));
		...
		fmsCommonWebElements.fmsBranchCode().sendKeys(MTS_LoginTestData.get("BranchCode"));
		waitHelper.waitForElementwithFluentwait(driver, fmsCommonWebElements.fmsCompanyAndBranchLogin());
