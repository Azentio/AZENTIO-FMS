...
public class Request_for_financing_steps {
	...
	ExcelData ExcelData =  new ExcelData(path, "Request", "Data Set ID");
	ExcelData bajApplicationTestData =  new ExcelData(path, "Baj Application", "Data Set ID");
	...
	ExcelData fmsTransactionsExcelData4 = new ExcelData(path, "Batch MTS", "Data Set ID");
	Map<String, String> testData4;
	ExcelData fmsTransactionsExcelData5 = new ExcelData(path, "Request", "Data Set ID");
	Map<String, String> testData5;
	
	
	
//	@Given("User update test data for test case no 1039018")
//	public void user_update_test_data_for_test_case_no_1039018() {
//		testData5 = fmsTransactionsExcelData5.getTestdata("AT_DDR_078");
//	}
	@Given("User update test data for test case no 1039018_2")
	public void user_update_test_data_for_test_case_no_1039018_2() {
		testData5 = fmsTransactionsExcelData5.getTestdata("AT_DDR_078");
	}
	
	@Given("User update test data for test case no 1265139")
	public void user_update_test_data_for_test_case_no_1265139() {
		testData5 = fmsTransactionsExcelData5.getTestdata("AT_CA_024");
	}
	
	@Given("User_607 Click Request under menu Options")
	public void user_click_request_under_menu_options() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.ClickRequest_under_menuOptions_607());
		Request_for_financing_Obj.ClickRequest_under_menuOptions_607().click();
	}

	@Given("User_607 Click Request Financing under Request")
	public void user_click_request_financing_under_request() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Click_Request_Financing_under_Request_607());
		Request_for_financing_Obj.Click_Request_Financing_under_Request_607().click();
	}
	...
	public void User_update_test_data_for_test_case_no_669589() {
		testData5 = fmsTransactionsExcelData5.getTestdata("AT_RF_021");
	}
...
//				"Modify Request");
		DropDownHelper.SelectUsingVisibleText(Request_for_financing_Obj.Select_reason_for_submission(),testData5.get("Reason For Submission"));
	...
	public void enter_value_on_existing_facility_no() throws Throwable {
		...
		Request_for_financing_Obj.enter_Existing_Facility_No().sendKeys(testData5.get("Existing Facility"));
...
//				}
	...
	public void enter_first_groupid() throws Throwable {
		...
		for (int i = 0; i < 300; i++) {
			try {
				...
				Request_for_financing_Obj.Click_In_and_enter_firstGroupID_onGroupLimit().sendKeys(testData5.get("First GroupID"));
	...
	public void enter_first_group_limit() throws Throwable {
		...
		Request_for_financing_Obj.Click_and_enter_firstlimit_onGroupLimit().sendKeys(testData5.get("First Group Limit"));
...
//			}
	//	Request_for_financing_Obj.Click_In_and_enter_FirstGroupname_onGroupLimit().sendKeys("dq");
		Request_for_financing_Obj.Click_In_and_enter_FirstGroupname_onGroupLimit().sendKeys(testData5.get("First Group Name"));
	}
	...
	public void enter_second_groupid() throws Throwable {
		...
		Request_for_financing_Obj.Click_In_and_enter_secondGroupID_onGroupLimit().sendKeys(testData5.get("Second GroupID"));
	...
	public void enter_second_group_limit() throws Throwable {
		...
		Request_for_financing_Obj.Click_and_enter_secondlimit_onGroupLimit().sendKeys(testData5.get("Second Group Limit"));
...
//	    }
	...
	public void click_process_button_in_management_process_branch_tab() throws Throwable {
	    ...
	    String RequestNo = Request_for_financing_Obj.get_approved_reqNo().getAttribute("value");
		
		// String transactionNo = CSMTransactionObject.getTransactionNumber().getText().substring(15, 19);
      //  System.out.println(transactionNo);
	    
	    bajApplicationTestData.updateTestData(testData2.get("Data Set ID"), "Enter Request No", RequestNo);
		System.out.println(bajApplicationTestData.getTestdata("Enter Request No"));
	...
	public void user_update_test_data_for_test_case_no_664435() {
		testData2 = bajApplicationTestData.getTestdata("AT_RF_022_D1");
	}
	...
	public void enter_request_no() throws Throwable {
		...
		Request_for_financing_Obj.Enter_req_no().sendKeys(testData2.get("Enter Request No"));
	...
	public void user_update_test_data_for_test_case_no_652870(){
		testData3 = fmsTransactionsExcelData3.getTestdata("AT_RF_052");
	...
	public void user_update_test_data_for_test_case_no_652912() {
		testData = fmsTransactionsExcelData5.getTestdata("AT_RF_053");
	}
	...
	public void user_update_test_data_for_test_case_no_636958() {
		testData5 = fmsTransactionsExcelData5.getTestdata("AT_RF_054");
	}
	@Given("User update test data for test case no 853171")
	public void user_update_test_data_for_test_case_no_853171() {
		testData5 = fmsTransactionsExcelData5.getTestdata("AT_IFO_001");
	}
	...
	public void click_the_customer_search_box() throws Throwable {
		...
		Request_for_financing_Obj.customersearchbox().sendKeys(testData5.get("Customer CIF"));
	...
	public void enter_the_facility_type_code_under_facility_type() throws Throwable {
		...
		Request_for_financing_Obj.facilitytypedetailssearchbox().sendKeys("19");
	//	Request_for_financing_Obj.facilitytypedetailssearchbox().sendKeys(testData5.get("Facility Type"));
	...
	public void add_the_product_class_values_in_product_searchbox() throws Throwable {
		...
		Request_for_financing_Obj.productclasssearchbox().sendKeys(testData5.get("Product Class"));
		...
		if (!(Request_for_financing_Obj.CleanFlag_in_LimitDetails_requestForFinnancing_607().isSelected())) {
			Request_for_financing_Obj.CleanFlag_in_LimitDetails_requestForFinnancing_607().click();
		}
	...
	public void change_the_month_in_tenure() throws Throwable {
		...
		for (int i = 0; i <= 300; i++) {
			try {
				...
				Request_for_financing_Obj.tenure().sendKeys(testData5.get("Tenure"));
	...
	public void add_the_margin_values_in_margin() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				...
				Request_for_financing_Obj.marginsearchbox().sendKeys(testData5.get("Margin"), Keys.TAB);
				break;
			} catch (Exception e) {
				if (i == 300) {
					Assert.fail(e.getMessage());
...
//	    	}
	...
	StringBuffer refIDinUnderMainteanceRequestForFinancing = new StringBuffer();
	...
	public void save_all_the_values_when_limits_are_add() throws Throwable {
		...
		refIDinUnderMainteanceRequestForFinancing.append(substring);
		System.err.println("Reference Number: " + refIDinUnderMainteanceRequestForFinancing);
...
//	    	
	...
	public void click_the_final_validate_popup() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.confirmPopup_610());
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.facilityAlreadyCreatedPopup_610());
		
		Request_for_financing_Obj.facilityAlreadyCreatedPopup_610().click();
	...
	public void enter_the_reason_for_rejection() throws Throwable {
		...
		DropDownHelper.SelectUsingVisibleText(Request_for_financing_Obj.select_reasonForRejection(), testData5.get("Reason For Rejection"));

		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Type_detailsIn_reasonForRejection());
		Request_for_financing_Obj.Type_detailsIn_reasonForRejection().sendKeys(testData5.get("Type Details"));
...
//	    	Request_for_financing_Obj.Click_clear_search_in_approve_reject().click();
	...
	public void change_the_months() throws Throwable {
		...
		Request_for_financing_Obj.tenure().sendKeys(testData5.get("Change Months in Tenure"));
...
//	    	Request_for_financing_Obj.Search_value_on_approve1().sendKeys(refIDinUnderMainteanceRequestForFinancing);
...
//		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.WaitToVisibilityRecordinApproveLev1_underRequestForFinancing());
//		String TotalvalueVisible = "";
//		for (int i = 0; i < 1000; i++) {
//			if (TotalvalueVisible.isEmpty()) {
//				TotalvalueVisible = Request_for_financing_Obj.WaitToVisibilityRecordinApproveLev1_underRequestForFinancing().getAttribute("prevvalue");
//			}
//		}
	...
	@Given("User_607 Forward the record in Approve level1 to Authorize and Reject")
	public void user_forward_the_record_in_approve_level1_to_authorize_and_reject() {
		...
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.ForwardRecord_inApproveLev1_underRequestForFinancing_607());
		DropDownHelper.SelectUsingVisibleText(Request_for_financing_Obj.ForwardRecord_inApproveLev1_underRequestForFinancing_607(), "Authorize / Reject");
	...
	@Given("User_607 update test data for test case no 749102")
	public void user_update_test_data_for_test_case_no_749102() {
		testData4 = fmsTransactionsExcelData4.getTestdata("AT_RF_148");
	}
	...
	public void enter_additional_reference() {
		...
		Request_for_financing_Obj.Enter_additionalReference().sendKeys(testData4.get("Additional Reference"));
	...
	public void enter_brief_name_in_main_information() {
		...
		Request_for_financing_Obj.Enter_briefName().sendKeys(testData4.get("Brief Name"));
	...
	public void enter_long_name_in_main_information() {
		...
		Request_for_financing_Obj.Enter_LongName().sendKeys(testData4.get("Long Name"));

		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Enter_Menu_Reference());
		Request_for_financing_Obj.Enter_Menu_Reference().sendKeys(testData4.get("Menu Reference"));
	...
	public void select_batch_periodicity_in_main_information() {
		...
		for (int i = 0; i <= 300; i++) {
			try {
				DropDownHelper.SelectUsingVisibleText(Request_for_financing_Obj.Select_batchPeriodicity(), testData4.get("Select batch Periodicity"));
				break;
			} catch (Exception e) {
				if (i == 300) {
					Assert.fail(e.getMessage());
	...
	// @749155
	@Given("User_607 update test data for test case no 749155")
	public void user_update_test_data_for_test_case_no_749155() {
		testData5 = fmsTransactionsExcelData5.getTestdata("AT_RF_150");
	}
	...
	public void select_decision_in_approve_level() {
		...
		DropDownHelper.SelectUsingVisibleText(Request_for_financing_Obj.select_Decision_in_approvelev1(), testData5.get("Decision in approve level1"));

		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Select_approveCommite_afterDecision());
		DropDownHelper.SelectUsingVisibleText(Request_for_financing_Obj.Select_approveCommite_afterDecision(), testData5.get("Approve Commite after Decision"));

		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.After_select_approveCommite_selectIC());
		DropDownHelper.SelectUsingVisibleText(Request_for_financing_Obj.After_select_approveCommite_selectIC(), testData5.get("Select approve Commite selectIC"));
...
//		DropDownHelper.SelectUsingVisibleText(Request_for_financing_Obj.select_oneOff_inFacility_Type_Details(), testData.get("Select oneOff inFacility Type Details"));
//		
//	}
...
//		Request_for_financing_Obj.enter_drawdown_type().sendKeys(testData.get("DrawDown Type"));
//		
//	}
//
...
//		Request_for_financing_Obj.enter_Description_English().sendKeys(testData.get("Description English"));
//
//		waitHelper.waitForElementwithFluentwait(driver,Request_for_financing_Obj.enter_valid_dateIn_drawDown_mainInformation());
//		Request_for_financing_Obj.enter_valid_dateIn_drawDown_mainInformation().sendKeys(testData.get("Description Date"));
//
//	}
//
...
//		Request_for_financing_Obj.Enter_value_Product_ClassLN().sendKeys(testData.get("Product ClassLN"));
//		Request_for_financing_Obj.Enter_value_Product_ClassLN().sendKeys(Keys.TAB);
//		
//		for (int i = 0; i <= 300; i++) {
//			if (!(Request_for_financing_Obj.Enter_value_Product_ClassLN().getAttribute("prevvalue").isBlank())) {
//				break;
//			}
//		}
//		waitHelper.waitForElementwithFluentwait(driver,Request_for_financing_Obj.Enter_FC_ammount());
//		Request_for_financing_Obj.Enter_FC_ammount().sendKeys(testData.get("FC Ammount"));
//		Request_for_financing_Obj.Enter_FC_ammount().sendKeys(Keys.TAB);
//		
//	
...
//		Request_for_financing_Obj.confirmsavepopupokbutton().click();
//		
//		waitHelper.waitForElementwithFluentwait(driver,Request_for_financing_Obj.Click_yes_in_postApproval());
//		Request_for_financing_Obj.Click_yes_in_postApproval().click();
//
//		
//		waitHelper.waitForElementwithFluentwait(driver,Request_for_financing_Obj.Click_okOn_save_pop());
//		Request_for_financing_Obj.Click_okOn_save_pop().click();
...
//403133
	@Given("User_607 Change the Language into French")
	public void change_the_language_into_french() {
		waitHelper.waitForElementwithFluentwait(driver,Request_for_financing_Obj.Change_Language());
		Request_for_financing_Obj.Change_Language().click();
		
		waitHelper.waitForElementwithFluentwait(driver,Request_for_financing_Obj.Select_LanguageIn_French());
		Request_for_financing_Obj.Select_LanguageIn_French().click();

	   
	}
	@Given("User_607 Search the record in  Maintanance screen")
	public void user_search_the_record_in_maintanance_screen() {
		waitHelper.waitForElementwithFluentwait(driver,Request_for_financing_Obj.search_recordIn__maintenace_under_request_for_financing_607());
		Request_for_financing_Obj.search_recordIn__maintenace_under_request_for_financing_607().click();

	}

	@Given("User_607 Select the record in the Maintenance under request for financing")
	public void user_select_the_record_in_the_maintenance_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver,Request_for_financing_Obj.Clearsearch_recordIn__maintenace_under_request_for_financing_607());
		Request_for_financing_Obj.Clearsearch_recordIn__maintenace_under_request_for_financing_607().click();
		
		waitHelper.waitForElementwithFluentwait(driver,Request_for_financing_Obj.select_recordIn__maintenace_under_request_for_financing_607());
		clicksAndActionsHelper.doubleClick(Request_for_financing_Obj.select_recordIn__maintenace_under_request_for_financing_607());
	...
	@Given("Goto maintenace under request for financing under request financing")
	public void goto_maintenace_under_request_for_financing_under_request_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.cLICK_MAINTEANCE_under_RequestForFinancing_607());
		Request_for_financing_Obj.cLICK_MAINTEANCE_under_RequestForFinancing_607().click();

		}
	@Given("User_607 Existing Facility No In Mainteance under Request For Financing")
	...
	@Given("User_607 Change Total limit In Mainteance under Request For Financing")
	public void user_change_total_limit_in_mainteance_under_request_for_financing() throws Throwable {
		Thread.sleep(10000);
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.EnterTotallimit_InMainteance_under_RequestForFinancing_607());
		clicksAndActionsHelper.doubleClick(Request_for_financing_Obj.EnterTotallimit_InMainteance_under_RequestForFinancing_607());
		Request_for_financing_Obj.EnterTotallimit_InMainteance_under_RequestForFinancing_607().sendKeys(testData5.get("Change Total limit"));
		Request_for_financing_Obj.EnterTotallimit_InMainteance_under_RequestForFinancing_607().sendKeys(Keys.TAB);
	   
	}

	@Given("User_607 Check Finance Amount In Mainteance under Request For Financing")
	public void user_check_finance_amount_in_mainteance_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.CheckFinance_Amount_InMainteance_under_RequestForFinancing_607());
		Request_for_financing_Obj.CheckFinance_Amount_InMainteance_under_RequestForFinancing_607().click();
		String check = "";
		for (int i = 0; i <= 300; i++) {
			check = Request_for_financing_Obj.CheckFinance_Amount_InMainteance_under_RequestForFinancing_607().getAttribute("value");
		...
		DropDownHelper.SelectUsingVisibleText(Request_for_financing_Obj.SelectReason_ModificationReason_InMainteance_under_RequestForFinancing_607(), testData5.get("Select Reason Modification Reason"));
		...
		Request_for_financing_Obj.TextReason_ModificationReason_InMainteance_under_RequestForFinancing_607().sendKeys(testData5.get("Text Reason Modification Reason"));
	...
	@Given("User_607 Click Disbursement Sublimit In Mainteance under Request For Financing")
	public void user_click_disbursement_sublimit_in_mainteance_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Click_DisbursementSublimit_InMainteance_under_RequestForFinancing_607());
		Request_for_financing_Obj.Click_DisbursementSublimit_InMainteance_under_RequestForFinancing_607().click();

	}

	@Given("User_607 Check total limit In Disbursement Sublimit")
	public void user_check_total_limit_in_disbursement_sublimit() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Check_total_limit_InDisbursementSublimit_607());
		String check = "";
		for (int i = 0; i <= 300; i++) {
			check = Request_for_financing_Obj.Check_total_limit_InDisbursementSublimit_607().getText();
			if (check.equalsIgnoreCase("5,000.000")) {
				break;
			}
		}
	...
	@Given("User_607 Click Save button In Mainteance under Request For Financing")
	public void user_click_save_button_in_mainteance_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.click_Save_btn_inInMainteance_under_RequestForFinancing_607());
		Request_for_financing_Obj.click_Save_btn_inInMainteance_under_RequestForFinancing_607().click();
	...
	@Given("User_607 Click Validate button In Mainteance under Request For Financing")
	public void user_click_validate_button_in_mainteance_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.click_validate_btn_inInMainteance_under_RequestForFinancing_607());
		Request_for_financing_Obj.click_validate_btn_inInMainteance_under_RequestForFinancing_607().click();
	...
	public void user_click_approve_level1_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Click_ApproveLevel1_under_RequestForFinancing_607());
		Request_for_financing_Obj.Click_ApproveLevel1_under_RequestForFinancing_607().click();
	   
	}

	@Given("User_607 Select Record In Approve Level1 under Request For Financing")
	public void user_select_record_in_approve_level1_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Click_clearSearch_InApproveLevel1_under_RequestForFinancing_607());
		Request_for_financing_Obj.Click_clearSearch_InApproveLevel1_under_RequestForFinancing_607().click();
		
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Select_Record_InApproveLevel1_under_RequestForFinancing_607());
		clicksAndActionsHelper.doubleClick(Request_for_financing_Obj.Select_Record_InApproveLevel1_under_RequestForFinancing_607());
	...
	public void user_click_finance_amount_in_approve_level1() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Click_Finance_Amount_InApproveLevel1_607());
		String check = "";
		for (int i = 0; i <= 300; i++) {
	...
	public void user_click_disbursement_sublimit_in_approve_level1_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Click_DisbursementSublimit_InApproveLevel1_under_RequestForFinancing_607());
		Request_for_financing_Obj.Click_DisbursementSublimit_InApproveLevel1_under_RequestForFinancing_607().click();

	   
	}

	@Given("User_607 Click Disbursement Sublimit In Disbursement Sublimi Approve Level1")
	public void user_click_disbursement_sublimit_in_disbursement_sublimi_approve_level1() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Check_Totallimit_InDisbursementSublimit_ApproveLevel1_607());
		String check = "";
		for (int i = 0; i <= 300; i++) {
			check = Request_for_financing_Obj.Check_Totallimit_InDisbursementSublimit_ApproveLevel1_607().getText();
			if (check.equalsIgnoreCase("5,000.000")) {
				break;
			}
		}
	...
	@Given("User_607 select Approed record In Maintenance under Facilities Management")
	public void User_607_select_approed_record_in_maintenance_under_facilities_management() {
		waitHelper.waitForElementwithFluentwait(driver,Request_for_financing_Obj.click_searchIn_Maintenance_under_Facilities_Managementunder());
		try {
			for (int i = 0; i < 400; i++) {
				Request_for_financing_Obj.click_searchIn_Maintenance_under_Facilities_Managementunder().click();
		...
		waitHelper.waitForElementwithFluentwait(driver,Request_for_financing_Obj.SearchStatusIn_drawDownRequest_AdditionalDetailsTab_607());
		Request_for_financing_Obj.SearchStatusIn_drawDownRequest_AdditionalDetailsTab_607().click();
		Request_for_financing_Obj.SearchStatusIn_drawDownRequest_AdditionalDetailsTab_607().sendKeys("Approved",Keys.ENTER);
	...
	@Given("User_607 Check Down Payment In draw Down Request Additional Details Tab")
	public void user_check_down_payment_in_draw_down_request_additional_details_tab() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Check_Down_PaymentIn_drawDownRequest_AdditionalDetailsTab_607());
		if (!Request_for_financing_Obj.Check_Down_PaymentIn_drawDownRequest_AdditionalDetailsTab_607().isDisplayed()) {
			Assert.fail();
		}
		
	}

	@Given("User_607 Check down payment to vendor In draw Down Request Additional Details Tab")
	public void user_check_down_payment_to_vendor_in_draw_down_request_additional_details_tab() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Check_down_payment_to_vendorIn_drawDownRequest_AdditionalDetailsTab_607());
		if (!Request_for_financing_Obj.Check_down_payment_to_vendorIn_drawDownRequest_AdditionalDetailsTab_607().isDisplayed()) {
			Assert.fail();
		}
		
	}

	@Given("User_607 Check Total Down Payment In draw Down Request Additional Details Tab")
	public void user_check_total_down_payment_in_draw_down_request_additional_details_tab() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Check_TotalDownPaymentIn_drawDownRequest_AdditionalDetailsTab());
		if (!Request_for_financing_Obj.Check_TotalDownPaymentIn_drawDownRequest_AdditionalDetailsTab().isDisplayed()) {
			Assert.fail();
		}
	...
	@Given("User_607 Forward the record in Approve level1")
	public void user_forward_the_record_in_approve_level1() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Click_Customer_Grading_Recommendations_For_reject());
		Request_for_financing_Obj.Click_Customer_Grading_Recommendations_For_reject().click();
		...
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.ForwardRecord_inApproveLev1_underRequestForFinancing_607());
		DropDownHelper.SelectUsingVisibleText(Request_for_financing_Obj.ForwardRecord_inApproveLev1_underRequestForFinancing_607(), testData5.get("Approve Commite after Decision"));
		
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.SelectApprovalCommittee_inApproveLev1_underRequestForFinancing_607());
		DropDownHelper.SelectUsingVisibleText(Request_for_financing_Obj.SelectApprovalCommittee_inApproveLev1_underRequestForFinancing_607(), testData5.get("Approve Commite after Decision"));

	}
	StringBuffer refIDinApproveLev1UnderRequestForFinancing = new StringBuffer();
	@Given("User_607 Click Approve button in Approve lev1 under Request For Financing")
	public void user_click_approve_button_in_approve_lev1_under_request_for_financing() {
    	...
    	String SuccessMsg = Request_for_financing_Obj.limitDetailsValidateSuccessMsg().getText();
		String substring = SuccessMsg.substring(23, 27);
		refIDinApproveLev1UnderRequestForFinancing.append(substring);
		System.err.println("Reference Number: " + refIDinApproveLev1UnderRequestForFinancing);
    
		Request_for_financing_Obj.ButtonSuccessOk().click();
		    
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.sendAlertPopupIN_Req_607());
		Request_for_financing_Obj.sendAlertPopupIN_Req_607().click();
	
				
		
	}

	@Given("User_607 Click Approval Committee Rcommendations under Request For Financing")
	public void user_click_approval_committee_rcommendations_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.ClickApproval_Committee_Recommendations_underRequestForFinancing_607());
		Request_for_financing_Obj.ClickApproval_Committee_Recommendations_underRequestForFinancing_607().click();
		
    	
    	}

	@Given("User_607 Select record In Approval Committee Recommendations under Request For Financing")
	public void user_select_record_in_approval_committee_recommendations_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Click_ClrSearchIn_Approval_Committee_Recommendations_underRequestForFinancing_607());
		Request_for_financing_Obj.Click_ClrSearchIn_Approval_Committee_Recommendations_underRequestForFinancing_607().click();
		
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Select_record_In_Approval_Committee_Recommendations_underRequestForFinancing_607());
		clicksAndActionsHelper.doubleClick(Request_for_financing_Obj.Select_record_In_Approval_Committee_Recommendations_underRequestForFinancing_607());
	}

	@Given("User_607 Click credit Committee Recommendations Tab In Approval Committee Recommendations under Request For Financing")
	public void user_click_credit_committee_recommendations_tab_in_approval_committee_recommendations_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Click_creditCommitteeRecommendationsTab_In_Approval_Committee_Recommendations_underRequestForFinancing_607());
		Request_for_financing_Obj.Click_creditCommitteeRecommendationsTab_In_Approval_Committee_Recommendations_underRequestForFinancing_607().click();
		
	}

	@Given("User_607 Click RecommendationsArrow In credit Committee Recommendations Tab In Approval Committee Recommendations")
	public void user_click_recommendations_arrow_in_credit_committee_recommendations_tab_in_approval_committee_recommendations() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Click_RecommendationsArrow_IncreditCommitteeRecommendationsTab_InApproval_Committee_Recommendations_607());
		Request_for_financing_Obj.Click_RecommendationsArrow_IncreditCommitteeRecommendationsTab_InApproval_Committee_Recommendations_607().click();
	}

	@Given("User_607 Click Add In RecommendationsArrow In Approval Committee Recommendations")
	public void user_click_add_in_recommendations_arrow_in_approval_committee_recommendations() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.ClickAddIn_RecommendationsArrow_InApproval_Committee_Recommendations_607());
		Request_for_financing_Obj.ClickAddIn_RecommendationsArrow_InApproval_Committee_Recommendations_607().click();
	
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.ClickSelectFirstLineIn_RecommendationsArrow_InApproval_Committee_Recommendations_607());
		Request_for_financing_Obj.ClickSelectFirstLineIn_RecommendationsArrow_InApproval_Committee_Recommendations_607().click();
		
	}

	@Given("User_607 Select Approve In First Line In RecommendationsArrow In Approval Committee Recommendations")
	public void user_select_approve_in_first_line_in_recommendations_arrow_in_approval_committee_recommendations() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.SelectApprove_InFirstLineIn_RecommendationsArrow_InApproval_Committee_Recommendations_607());
		DropDownHelper.SelectUsingVisibleText(Request_for_financing_Obj.SelectApprove_InFirstLineIn_RecommendationsArrow_InApproval_Committee_Recommendations_607(),testData5.get("credit Committee Recommendations"));
		
	}

	@Given("User_607 Click Recommebd button In Approval Committee Recommendations under Request For Financing")
	public void user_click_recommebd_button_in_approval_committee_recommendations_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Click_RecommebdBtn_InApproval_Committee_Recommendations_underRequestForFinancing_607());
		for (int i = 0; i < 700; i++) {
			Request_for_financing_Obj.Click_RecommebdBtn_InApproval_Committee_Recommendations_underRequestForFinancing_607().click();
			break;
		}
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.ButtonConfirmOk());
		for (int i = 0; i < 700; i++) {
    	...
    	try {
    		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.sendAlertPopup_610());
    		for (int i = 0; i < 2000; i++) {
    			try {
    				Request_for_financing_Obj.sendAlertPopupIN_Req_607().click();
    				break;
	...
	@Given("User_607 Click authorice Reject under Request For Financing")
	public void user_click_authorice_reject_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Click_authoriceReject_underRequestForFinancing_607());
		Request_for_financing_Obj.Click_authoriceReject_underRequestForFinancing_607().click();
	
	}

	@Given("User_607 Search Code In authorice Reject under Request For Financing")
	public void user_search_code_in_authorice_reject_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.SearchCode_InauthoriceReject_underRequestForFinancing_607());
		Request_for_financing_Obj.SearchCode_InauthoriceReject_underRequestForFinancing_607().sendKeys(refIDinApproveLev1UnderRequestForFinancing,Keys.ENTER);
		
	}


	@Given("User_607 Check the record in authorice Reject under Request For Financing")
	public void user_check_the_record_in_authorice_reject_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.SelectRecord_InauthoriceReject_underRequestForFinancing_607());
		clicksAndActionsHelper.doubleClick(Request_for_financing_Obj.SelectRecord_InauthoriceReject_underRequestForFinancing_607());
	}
	
	//853171
	
	@Given("User_607 click Authorize Reject Under Request For Financing")
	public void user_click_authorize_reject_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.clickAuthorizeReject_Under_RequestForFinancing_607());
		Request_for_financing_Obj.clickAuthorizeReject_Under_RequestForFinancing_607().click();
	    
	}

	@Given("User_607 Search Record In Authorize Reject Under Request For Financing")
	public void user_search_record_in_authorize_reject_under_request_for_financing() throws Throwable {
		
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.SearchRecordInAuthorizeReject_Under_RequestForFinancing_607());
		Request_for_financing_Obj.SearchRecordInAuthorizeReject_Under_RequestForFinancing_607().sendKeys(refIDinApproveLev1UnderRequestForFinancing,Keys.ENTER);
		
	}

	@Given("User_607 Select Record In Authorize Reject Under Request For Financing")
	public void user_select_record_in_authorize_reject_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.SelectRecordInAuthorizeReject_Under_RequestForFinancing_607());
		clicksAndActionsHelper.doubleClick(Request_for_financing_Obj.SelectRecordInAuthorizeReject_Under_RequestForFinancing_607());
	}

	@Given("User_607 Click Authorize button In Authorize Reject Under Request For Financing")
	public void user_click_authorize_button_in_authorize_reject_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Click_AuthorizeBtnInAuthorizeReject_Under_RequestForFinancing());
		Request_for_financing_Obj.Click_AuthorizeBtnInAuthorizeReject_Under_RequestForFinancing().click();
    	...
    	waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.sendAlertPopupIN_ReqAutorize_607());
		for (int i = 0; i < 2000; i++) {
			try {
				Request_for_financing_Obj.sendAlertPopupIN_ReqAutorize_607().click();
				break;
			} catch (Exception e) {
				if (i == 1999) {
					Assert.fail(e.getMessage());
	...
	@Given("User_607 Click Issue Facility Offer Under Request For Financing")
	public void user_click_issue_facility_offer_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Click_IssueFacilityOffer_Under_RequestForFinancing_607());
		Request_for_financing_Obj.Click_IssueFacilityOffer_Under_RequestForFinancing_607().click();
		
	}

	@Given("User_607 Select Record In Issue Facility Offer Under Request For Financing")
	public void user_select_record_in_issue_facility_offer_under_request_for_financing() throws Throwable {
		
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.SearchRecord_In_IssueFacilityOffer_Under_RequestForFinancing_607());
		Request_for_financing_Obj.SearchRecord_In_IssueFacilityOffer_Under_RequestForFinancing_607().sendKeys(refIDinApproveLev1UnderRequestForFinancing,Keys.ENTER);
		
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.SelectRecord_In_IssueFacilityOffer_Under_RequestForFinancing_607());
		clicksAndActionsHelper.doubleClick(Request_for_financing_Obj.SelectRecord_In_IssueFacilityOffer_Under_RequestForFinancing_607());
	    
	}

	@Given("User_607 Click Issue offer button In Issue Facility Offer Under Request For Financing")
	public void user_click_issue_offer_button_in_issue_facility_offer_under_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.ClickIssueofferBtn_In_IssueFacilityOffer_Under_RequestForFinancing_607());
		Request_for_financing_Obj.ClickIssueofferBtn_In_IssueFacilityOffer_Under_RequestForFinancing_607().click();
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.ButtonConfirmOk());
		for (int i = 0; i < 700; i++) {
			Request_for_financing_Obj.ButtonConfirmOk().click();
			break;
	...
	@Given("User_607 Click Authorize button In Authorize Reject Under Request For Financing for alert")
	public void user_click_authorize_button_in_authorize_reject_under_request_for_financing_for_alert() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.Click_AuthorizeBtnInAuthorizeReject_Under_RequestForFinancing());
		Request_for_financing_Obj.Click_AuthorizeBtnInAuthorizeReject_Under_RequestForFinancing().click();
	...
	@Given("User_607 Search User in Alert Popup")
	public void user_search_user_in_alert_popup() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.SearchUser_inAlertPopup_607());
		Request_for_financing_Obj.SearchUser_inAlertPopup_607().sendKeys("MODEL.B",Keys.ENTER);
	}

	@Given("User_607 Select User in Alert Popup")
	public void user_select_user_in_alert_popup() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.SelectUser_inAlertPopup_607());
		Request_for_financing_Obj.SelectUser_inAlertPopup_607().click();
	}

	@Given("User_607 Click Send button in Alert Popup")
	public void user_click_send_button_in_alert_popup() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.ClickSendBtn_inAlertPuppop_607());
		Request_for_financing_Obj.ClickSendBtn_inAlertPuppop_607().click();
	}

	@Given("User_607 Click Open items in Alert popup")
	public void user_click_open_items_in_alert_popup() {
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.AlertPopUp_607());
		
		waitHelper.waitForElementwithFluentwait(driver, Request_for_financing_Obj.ClickOpen_items_in_Alertpopup_607());
		Request_for_financing_Obj.ClickOpen_items_in_Alertpopup_607().click();
	}
