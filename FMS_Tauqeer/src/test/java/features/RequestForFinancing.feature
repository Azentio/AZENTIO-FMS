...
@AT_RF_090
Scenario: ITFCI160188 - Lookup query Credit rating is not getting data
Given navigate to FMS application and login with valid credentials
And User_482 Click on REQUEST FOR FINANCIN under FMS application
And User_482 click the Request For Financing Sub Menu under REQUEST FOR FINANCIN
And User_482 Click on Maintenance under Request For Financing Sub Menu in REQUEST FOR FINANCIN
...
And user_483 click on 1st category under approved commodities
...
@AT_FM_07111
Scenario: Create a Facility with CIF with the above Request for Finance
Given navigate to FMS application and login with valid credentials1
And User_482 click Technical details
And User_482 click clear caches
And User_482 Click on Ok button in Success Pop up Menu
...
# And user_482 enter the Revolving OneOff under Facility Type Details under Maintainence
...
#And User_482 enter the Maturity Date
