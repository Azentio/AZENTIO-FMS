...
public class ApplicationForFacility_482 extends BaseClass {
	...
	ExcelData excelData2 = new ExcelData(path,"RequestForFinancing_482","DataSet ID");
	...
	//TQ
	@And("User_482 update Test data set for AT_RF_089")
	public void user_482_update_test_data_set_for_at_rf_089() {
		testExecutionData = testExecution.getTestdata("AT_RF_089");
    	testData = requestForFinancingData.getTestdata(testExecutionData.get("Data Set ID"));
    	System.out.println(testData.get("RequestID"));
    	
	}
	@And("^User_482 Update Test data set for AT_RF_089_d1$")
    public void User_482_Update_Test_data_set_for_AT_RF_008_d1() {
    	testData=excelData2.getTestdata("AT_RF_008_D1");
 ...
 //****************************************************Market Field TestCase***********************************************//
    ...
    //tauqtest
    @And("user_482 click on tauq test main menu")
    public void user_482_click_on_tauq_test_main_menu(){
    	seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,applicationForFinancialFacilityObj.fmsTauqTest_MainMenu());
		seleniumActions.getClickAndActionsHelper().moveToElement(applicationForFinancialFacilityObj.fmsTauqTest_MainMenu());
		seleniumActions.getClickAndActionsHelper().clickOnElement(applicationForFinancialFacilityObj.fmsTauqTest_MainMenu());
    }
    
    @And("user_482 click on tauq test sub menu")
    public void user_482_click_on_tauq_test_sub_menu(){
    	seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,applicationForFinancialFacilityObj.fmsTauqTest_SubMenu());
		seleniumActions.getClickAndActionsHelper().moveToElement(applicationForFinancialFacilityObj.fmsTauqTest_SubMenu());
		seleniumActions.getClickAndActionsHelper().clickOnElement(applicationForFinancialFacilityObj.fmsTauqTest_SubMenu());
    }
    
    @And("user_482 click the requests for financing under tauq test sub menu")
    public void user_482_click_the_request_for_financing_under_under_tauq_test_sub_menu() {
    	seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
    			                           applicationForFinancialFacilityObj.fms_tauq_test_RequestForFinancing());
    ...
    @And("user_482 click the maintainence screen under tauq test sub module")
    public void user_482_click_the_maintainence_screen_under_tauq_test_sub_module() {
    	seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
                    applicationForFinancialFacilityObj.fms_tauqtest_RequestForFinancing__Maintainence());
    ...
    @And("user 483 select new request in reason for submission under maintenance screen in request for financing")
    public void user_483_select_new_request_in_reason_for_submission_under_maintenance_screen_in_tauq_test() {
    	seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
                applicationForFinancialFacilityObj.fms_tauqtest_Maintainence_RequestForSubmission());
    	seleniumActions.getClickAndActionsHelper().clickOnElement(
    			  applicationForFinancialFacilityObj.fms_tauqtest_Maintainence_RequestForSubmission());
    	
    	
    	applicationForFinancialFacilityObj.fms_tauqtest_Maintainence_RequestForSubmission().sendKeys("New Request");
    }
    
    
    @And("user_483 select the info completion date under maintenance screen under request for financing tab")
    public void user_483_select_the_info_completion_date_under_maintenance_screen_under_request_for_financing_tab() {
    	seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
    	...
    	seleniumActions.getClickAndActionsHelper().clickOnElement(
    	 ...
    	 applicationForFinancialFacilityObj.fms_tauqtest_Maintainence_InfoCompletionDate().sendKeys("16/01/2021");
    	
    }
    
    
    @And("user_483 select the cif number under maintenance screen under request for financing tab")
    public void user_483_select_the_cif_number_under_maintenance_screen_under_request_for_financing_tab() {
    	seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
    	...
    	seleniumActions.getClickAndActionsHelper().clickOnElement(
    	 ...
    	 applicationForFinancialFacilityObj.fms_tauqtest_Maintainence_CIF().sendKeys("727");
    }
    
    
	/*
	 * @And("user_483 click on the commodities and security components under maintenance screen under request for financing tab"
	 * ) public void
	 * user_483_click_on_the_commodities_and_security_components_under_maintenance_screen_under_request_for_financing_tab
	 * () { seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
	 * applicationForFinancialFacilityObj.
	 * fms_tauqtest_Maintainence_CommoditiesAndSecurityComponents());
	 * seleniumActions.getClickAndActionsHelper().clickOnElement(
	 * applicationForFinancialFacilityObj.
	 * fms_tauqtest_Maintainence_CommoditiesAndSecurityComponents());
	 * 
	 ...
	 * 
	 * 
	 * @And("user_483 click on the add button under Approved Commodities under commodities and security components"
	 * ) public void
	 * user_483click_on_the_add_button_under_approved_commodities_under_commodities_and_security_components
	 * () { seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
	 * applicationForFinancialFacilityObj.
	 * fms_tauqtest_Maintainence_ApprovedCommoditiesAddBtn());
	 * seleniumActions.getClickAndActionsHelper().clickOnElement(
	 * applicationForFinancialFacilityObj.
	 * fms_tauqtest_Maintainence_ApprovedCommoditiesAddBtn()); }
	 * 
	 * 
	 * @And("user_483 click on 1st category under approved commodities") public void
	 * user_483_click_on_1st_category_under_approved_commodities() {
	 * seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
	 * applicationForFinancialFacilityObj.
	 * fms_tauqtest_Maintainence_ApprovedCommodities_Category1()); //
	 * seleniumActions.getClickAndActionsHelper().clickOnElement( //
	 * applicationForFinancialFacilityObj.
	 * fms_tauqtest_Maintainence_ApprovedCommodities_Category1());
	 * applicationForFinancialFacilityObj.
	 * fms_tauqtest_Maintainence_ApprovedCommodities_Category1().click(); }
	 * 
	 * @And("user_483 define the category under 1st category under approved commodities"
	 * ) public void
	 * user_483_define_the_category_under_1st_category_under_approved_commodities()
	 * { seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
	 * applicationForFinancialFacilityObj.
	 ...
	 * sendKeys("0001"); }
	 * 
	 * @And("user_483 define the 1st code under subcategory under approved commodities"
	 * ) public void
	 * user_483_define_the_1st_code_under_subcategory_under_approved_commodities() {
	 * seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
	 * applicationForFinancialFacilityObj.
	 ...
	 * 
	 * 
	 * @And("user_483 define the 1st code under commodity under approved commodities"
	 * ) public void
	 * user_483_define_the_1st_code_under_commodity_under_approved_commodities() {
	 * seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
	 * applicationForFinancialFacilityObj.
	 ...
	 * }
	 * 
	 * @And("user_483 define the 1st expected percentage under approved commodities"
	 * ) public void
	 * user_483_define_the_1st_expected_percentage_under_approved_commodities() {
	 * seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
	 * applicationForFinancialFacilityObj.
	 * fms_tauqtest_Maintainence_ApprovedCommodities_ExpectedPercentage());
	 * //seleniumActions.getClickAndActionsHelper().clickOnElement( //
	 * applicationForFinancialFacilityObj.
	 * fms_tauqtest_Maintainence_ApprovedCommodities_ExpectedPercentage());
	 * 
	 * applicationForFinancialFacilityObj.
	 * fms_tauqtest_Maintainence_ApprovedCommodities_ExpectedPercentage().sendKeys(
	 * "50"); }
	 * 
	 * @And("user_483 click on 2nd category under category under approved commodities"
	 * ) public void
	 * user_483_click_on_2nd_category_under_2nd_category_under_approved_commodities(
	 * ) { seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
	 * applicationForFinancialFacilityObj.
	 * fms_tauqtest_Maintainence_ApprovedCommodities_Category2());
	 * seleniumActions.getClickAndActionsHelper().clickOnElement(
	 * applicationForFinancialFacilityObj.
	 * fms_tauqtest_Maintainence_ApprovedCommodities_Category2());
	 * 
	 * }
	 * 
	 * @And("user_483 define the 2nd category under category under approved commodities"
	 * ) public void
	 * user_483_define_the_2nd_category_under_category_under_approved_commodities()
	 * { seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
	 * applicationForFinancialFacilityObj.
	 ...
	 * 
	 * 
	 * @And("user_483 define the 2nd code under subcategory under appproved commodities"
	 * ) public void
	 * user_483_define_the_2nd_code_under_subcategory_under_appproved_commodities()
	 * { seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
	 * applicationForFinancialFacilityObj.
	 ...
	 * }
	 * 
	 * @And("user_483 define the 2nd code under commodity under approved commodities"
	 * ) public void
	 * user_483_define_the_2nd_code_under_commodity_under_approved_commodities() {
	 * seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
	 * applicationForFinancialFacilityObj.
    ...
    @And("user_483 verify the error message for dupicate under approved commodities")
    public void user_483_verify_the_error_message_for_dupicate_under_approved_commodities() {
    	String actualText="Duplicate Entry Of Record";
    	seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
                applicationForFinancialFacilityObj.fms_tauqtest_Maintainence_ApprovedCommodities_DuplicateErrorPopup());
        
    	String expectedResults=applicationForFinancialFacilityObj.
    			                     fms_tauqtest_Maintainence_ApprovedCommodities_DuplicateErrorPopup().getText();
    	
    	if(actualText.equalsIgnoreCase(expectedResults)){
    		System.out.println("Error occured : Duplicate Entry Of Record ");
    	}
...
//    	  applicationForFinancialFacilityObj.custodianDateSent_Document2_482().sendKeys(Keys.TAB);
      ...
      public void user_482_click_create_schedule_button_under_wifak_application() throws InterruptedException {
    	  ...
    	  seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,applicationForFinancialFacilityObj.totalAmountRepayment_WIFAK_482());
    	  int TotalAmount = Integer.parseInt(applicationForFinancialFacilityObj.totalAmountRepayment_WIFAK_482().getAttribute("prevvalue").replace(",", "").replace(".000", ""));
    	  ...
    	  for (int i = 1; i <InstallmentWebElement.size(); i++) {
    		  int InstallmentAmountSystem = Integer.parseInt(InstallmentWebElement.get(i).getText().replace(",","").replace(".00", ""));
      ...
      @And("user_482 click on the credit rating under request details and request for financing tab")
      public void user_482_click_on_the_credit_rating_under_request_details_and_request_for_financing_tab() {
    	  seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
    			  applicationForFinancialFacilityObj.fms_RequestForFinancing_CreditRating_SearchLookUp());
    	  seleniumActions.getClickAndActionsHelper().
    	           clickOnElement(applicationForFinancialFacilityObj.fms_RequestForFinancing_CreditRating_SearchLookUp());
      }
      
      @And("user_482 verify the records displaying under credit rating")
      public void user_482_verify_the_records_displaying_under_credit_rating() {
    	  seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
    			  applicationForFinancialFacilityObj.fms_RequestForFinancing_CreditRating_Records());
    	  Assert.assertTrue(applicationForFinancialFacilityObj.fms_RequestForFinancing_CreditRating_Records().isDisplayed());
