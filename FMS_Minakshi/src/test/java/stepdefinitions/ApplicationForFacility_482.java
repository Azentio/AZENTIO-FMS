...
public class ApplicationForFacility_482 extends BaseClass {
	...
	@And("^User_482 Click to status details$")
	  public void User_482_Click_to_status_details() {
		  seleniumActions.getWaitHelper().setImplicitWait(80);
	  		seleniumActions.getClickAndActionsHelper().moveToElement(applicationForFinancialFacilityObj.AFFstatusdetails());
	  		seleniumActions.getClickAndActionsHelper().clickOnElement(applicationForFinancialFacilityObj.AFFstatusdetails()); 
	  }
	  		@And("^User_482 verify date and time is visible$")
	  		public void User_482_verify_date_and_time_is_visible() {
	  	seleniumActions.getWaitHelper().setImplicitWait(80);
	Assert.assertTrue(applicationForFinancialFacilityObj.statusdetaildate().isDisplayed());
  		applicationForFinancialFacilityObj.statusdetaildate().getText();
	  		}
    ...
    public void user_enter_the_value_in_total_limit_under_maintenance_screen_in_request_for_financin() throws Throwable {
		...
		for (int i = 0; i <200; i++) {
  			try {
    			...
    			applicationForFinancialFacilityObj.totalLimitInRequestForFinancingScreen().sendKeys("100000");
    ...
    public void user_click_on_add_button_in_disbursement_or_sublimit_under_maintenance_screen_in_request_for_financin() throws Throwable {
    	...
    	seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,applicationForFinancialFacilityObj.retrivedatadoubleclick());
    	//seleniumActions.getClickAndActionsHelper().moveToElement(applicationForFinancialFacilityObj.retrivedatadoubleclick());
    	//seleniumActions.getClickAndActionsHelper().clickOnElement(applicationForFinancialFacilityObj.retrivedatadoubleclick());
    ...
    @And("^User_012 Click on Ok button in Success Pop up Menu$")
    public void user_012_click_on_ok_button_in_success_pop_up_menu() throws Throwable {
    	for (int i = 0; i <2000; i++) {
			try {
 ...
 //****************************************************Market Field TestCase***********************************************//
    ...
    public void user_482_enter_the_facility_type_in_main_info_tab_under_wirak_application() throws Throwable {
    	for (int i = 0; i <200; i++) {
			try {
				...
				//applicationForFinancialFacilityObj.mainFacilityType().sendKeys("740");
    ...
    @And("^User_482 Enter total value2 under additional details tab in WIFAK Application$")
    public void user_482_enter_total_value2_under_additional_details_tab_in_wifak_application() throws Throwable {
    	seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,applicationForFinancialFacilityObj.mainAdditionalTabTotalValue());
		seleniumActions.getClickAndActionsHelper().moveToElement(applicationForFinancialFacilityObj.mainAdditionalTabTotalValue());
		seleniumActions.getClickAndActionsHelper().clickOnElement(applicationForFinancialFacilityObj.mainAdditionalTabTotalValue());
		//applicationForFinancialFacilityObj.mainAdditionalTabTotalValue().sendKeys(testData.get("Total Value"));
		applicationForFinancialFacilityObj.mainAdditionalTabTotalValue().sendKeys("50000");
		applicationForFinancialFacilityObj.mainAdditionalTabTotalValue().sendKeys(Keys.ENTER);
...
//    	  seleniumActions.getClickAndActionsHelper().clickOnElement(applicationForFinancialFacilityObj.bankProfitShareInLimitDetailsWIFAKApplication());
      ...
      public void User_014_Check_that_the_Facility_Risk_Rating_are_reflected_at_the_level_of_Application_for_Financial_Facilities() {
    	  seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,applicationForFinancialFacilityObj.applicationfacilityfacilityRiskRatingbtn());
    	  for (int i = 0; i <200; i++) {
    			try {
    			  seleniumActions.getClickAndActionsHelper().moveToElement(applicationForFinancialFacilityObj.applicationfacilityfacilityRiskRatingbtn());
    	    	  //seleniumActions.getClickAndActionsHelper().clickOnElement(applicationForFinancialFacilityObj.applicationfacilityfacilityRiskRatingbtn());
    		     Assert.assertTrue(applicationForFinancialFacilityObj.applicationfacilityfacilityRiskRatingbtn().isDisplayed());
    	    	  break;
    			} catch (Exception e) {
    				if (i==199) {
    					Assert.fail(e.getMessage());
      ...
      public void User_018_Check_the_field_Profit_Rate_Margin_is_disabled() {
      seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,applicationForFinancialFacilityObj.MARGINRATE());
      
    	  for (int i = 0; i <200; i++) {
  			try {
  			  seleniumActions.getClickAndActionsHelper().moveToElement(applicationForFinancialFacilityObj.MARGINRATE());
  	    	  //seleniumActions.getClickAndActionsHelper().clickOnElement(applicationForFinancialFacilityObj.MARGINRATE());
  		     Assert.assertTrue(applicationForFinancialFacilityObj.MARGINRATE().isDisplayed());
  	    	  break;
  			} catch (Exception e) {
  				if (i==199) {
  					Assert.fail(e.getMessage());
