...
//	Investment Deals Combined without Trade Deal
	...
	@And("^user click on link tab under maintenance$")
	public void user_click_on_link_tab_under_maintenance(){
		waitHelper.waitForElementwithFluentwait(driver, incidentalChargesObj.linkkey());
		incidentalChargesObj.linkkey().click();
...
//		}
	...
	public void user_482_click_information_ok_deal_saved() throws Throwable {
		for (int i = 0; i <= 2000; i++) {
			try {
