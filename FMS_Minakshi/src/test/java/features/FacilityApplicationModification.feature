Feature: Testing the Functionalities of Facility Modification
@AT_FAM_015_01
Scenario: Create Facility to Modify
...
@AT_FAM_015
Scenario: Check the new field behavior in Modify/Review Reqest 
Given navigate to FMS application and login with valid credentials
