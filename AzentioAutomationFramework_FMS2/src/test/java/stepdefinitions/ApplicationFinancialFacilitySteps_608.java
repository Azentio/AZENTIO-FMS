...
//	@AT_AFF_036
	@And("^User_074 get the test data for test case AT_AFF_036$")
...
//	@AT_AFF_040
	@And("^User_074 get the test data for test case AT_AFF_040$")
...
//	@AT_AFF_048
	@And("^User_074 get the test data for test case AT_AFF_048$")
...
//	@AT_FM_058
	@And("User_074 get the test data for test case AT_FM_058")
...
//	@AT_AFF_052
	@And("^User_074 get the test data for test case AT_AFF_052$")
...
//	@AT_AFF_074
	@And("^User_074 get the test data for test case AT_AFF_074$")
...
//	@AT_AFF_098_FMSParam
	@And("^User_074 get the test data for test case AT_AFF_098_FMSParam$")
...
//	@AT_RF_099_FMSParam
	@And("^User_074 get the test data for test case AT_RF_099_FMSParam$")
...
//	@AT_RF_099_FMSCore
    @And("^User_074 get the test data for test case AT_RF_099_FMSCore$")
...
//  @AT_RF_100
    @And("^User_074 get the test data for test case AT_RF_100$")
...
//	@AT_RF_101_FMSParam
	@And("^User_074 get the test data for test case AT_RF_101_FMSParam$")
...
//  @AT_RF_101_FMSCore
    @And("^User_074 get the test data for test case AT_RF_101_FMSCore$")
...
//  @AT_RF_102
    @And("^User_074 get the test data for test case AT_RF_102$")
...
//  @AT_RF_014_FMSCore
    @And("^User_074 get the test data for test case AT_RF_014_FMSCore$")
...
//  @AT_RF_034  
    @And("^User_074 get the test data for test case AT_RF_034$")
...
//  @AT_RF_040
    @And("^User_074 get the test data for test case AT_RF_040$")
...
//	@AT_FM_038
	@And("^User_074 get the test data for test case AT_FM_038$")
...
//	@AT_FM_102
	@And("User_074 get the test data for test case AT_FM_102")
...
//	@AT_FM_103
	@And("User_074 get the test data for test case AT_FM_103")
...
//	@AT_FM_104
	@And("User_074 get the test data for test case AT_FM_104")
...
//	@AT_FM_105_FMSParam
	@And("^User_074 get the test data for test case AT_FM_105_FMSParam$")
...
//	@AT_FM_105_FMSCore
	@And("User_074 get the test data for test case AT_FM_105_FMSCore")
	public void user_get_the_test_data_for_test_case_AT_FM_105_FMSCore() throws Throwable {
		testData = fmsTransactionsExcelData.getTestdata("DS_AT_FM_105");
	}
	
//	@AT_FP_001
	@And("^User_074 get the test data for test case AT_FP_001$")
...
//	@AT_DDR_020
	@And("^User_074 get the test data for test case AT_DDR_020$")
...
//	@AT_DDR_022
	@And("^User_074 get the test data for test case AT_DDR_022$")
...
//	@AT_DDR_023
	@And("^User_074 get the test data for test case AT_DDR_023$")
...
//	@AT_DDR_024
	@And("^User_074 get the test data for test case AT_DDR_024$")
...
//	@AT_CA_008
    ...
    public void get_the_test_data_for_test_case_AT_AR_006() throws Throwable {
		testData = fmsTransactionsExcelData.getTestdata("DS_AT_AR_006");
    }
...
//		applicationFinancialFacilityObj608.mainAdditionalTabTotalValue().sendKeys("1000");
	...
	@Then("^User_074 Validate the floating rate with yield details$")
...
//	@AT_AFF_040
	@And("^User_074 clicks on the Approve level1 link$")
	...
	@And("^User_074 double click searched record$")
	...
	@And("^User_074 clicks on the History log tap$")
	...
	@Then("User_074 validate History log tab values should be displayed")
...
//	AT_AFF_048
	@And("User_074 retrive the Account number in limit details")
	...
	@And("User_074 clicks on the Charges details button under limit details")
	...
	@And("User_074 select the collect at facility approval flag")
	...
	@And("User_074 click the Ok button in Charges details under limit details")
...
//				}
    ...
    @And("User_074 select the Approve level1 decision as Forward")
    ...
    @And("User_074 select the Approve level1 decision Forward to Approve level3")
...
//    }
 ...
 // @AT_AFF_052
    @And("^User_074 clicks on the clear button under Approve level1$")
    ...
    @And("^User_074 double clicks on the first row of approve level1$")
    ...
    @And("^User_074 move to additional details tab in approve level1$")
    ...
    @When("^User_074 clicks on the BM Recommendations button$")
    ...
    @Then("^User_074 validate the BM Recommendations tab should be editable$")
 ...
 // @AT_AFF_056	
     ...
     @And("^User_074 clicks on the Facility category feature under Parameter$")
     ...
     @And("^User_074 clicks on the maintanance menu under Facility category$")
     ...
     @And("^User_074 clicks on the search button under Facility category maintanance$")
     ...
     @And("^User_074 double clicks on the any one row in Maintanance under Facility category$")
     ...
     @And("^User_074 clicks the CIF type search option in Maintanance under Facility category$")
     ...
     @And("^User_074 double click on the any one value in Maintanance under Facility category$")
...
//     	waitHelper.waitForElementwithFluentwait(driver, applicationFinancialFacilityObj608.mainCIFTypeData());
     ...
     @Then("^User_074 clicks on the save button and save the record in Maintanance under Facility category$")
...
// 	@AT_AFF_075
 	@And("^User_074 clicks on the control records feature under Parameter$")
     ...
     @And("^User_074 clicks on the update after approve menu under control records$")
     ...
     @And("^User_074 validate the Officer Assigned Required checkbox$")
     ...
     @And("^User_074 uncheck the Officer Assigned Required flag$")
     ...
     @And("^User_074 validate the Enable Markup Type checkbox$")
     ...
     @And("^User_074 uncheck the Enable Markup Type flag$")
     ...
     @And("^User_074 validate the Role of Officers Assigned menu$")
     ...
     @And("^User_074 validate the Party s History with Company menu$")
     ...
     @And("^User_074 validate the Member Countries$")
     ...
     @And("^User_074 clicks on the update button under Update after approve menu in control records$")
     ...
     @And("^User_074 check the Officer Assigned Required flag$")
     ...
     @And("^User_074 clicks on the approve menu under control records$")
     ...
     @Then("^User_074 clicks on the approve button in Approve menu under control records$")
...
//    @AT_AFF_074    
     @And("^User_074 clicks on the member countries tab in update after approve under control records$")
     ...
     @And("^User_074 clicks the add new row button under member countries tab in update after approve$")
     ...
     @And("^User_074 enter the country code under member countries tab in update after approve$")
...
//     	applicationFinancialFacilityObj608.countryCode().sendKeys("320");
	...
	@And("^User_074 clicks on the membership type dropdown under member countries tab in update after approve$")
...
//   @AT_AFF_098_FMSParam
     ...
     @And("^User_074 check the Customer Grading flag$")
     ...
     @And("^User_074 check the Overwrite Grading flag$")
     ...
     @And("^User_074 check the Credit Review flag$")
     ...
     @And("^User_074 check the Committee Approval flag$")
     ...
     @And("^User_074 uncheck the Committee Approval flag$")
     ...
     @And("^User_074 check the Credit Authorization flag$")
     ...
     @And("^User_074 check the Issue Facility Offer flag$")
     ...
     @And("^User_074 check the Client Response flag$")
     ...
     @And("^User_074 check the Document Validation flag$")
     ...
     @And("^User_074 check the Final Approval flag$")
     ...
     @And("^User_074 check the Create Active Facility If Within Limits flag$")
     ...
     @And("^User_074 Check the Automatically Approve Facility If Within Limits flag$")
     ...
     @When("^User_074 clicks on the Update button under update after approve menu in Facility type$")
     ...
     @And("^User_074 after the update go to the Approve menu$")
     ...
     @And("^User_074 enter the code value in Approve menu$")
     ...
     @And("^User_074 double click on the retrieved data in Approve menu$")
     ...
     @When("^User_074 clicks on the Approve button in Approve menu under Facility Type$")
 ...
 //  @AT_AFF_098_FMSCore
     @And("^User_074 define the marketed by field in main info tab$")
...
//   @AT_AFF_098_CSMCore    
   @And("^User_074 clicks on the transfer of entities module$")
   ...
   @And("^User_074 clicks on the transfer of entities maintanance menu$")
...
//   @AT_FM_058
   	@And("User_074 enter the Application Ref number in Facilities Management Maintanance Search grid under WIFAK Application")
...
//     @AT_FM_102
     @And("User_074 user Re_enter the no of payments in Repayment Plan tab Application Financial Facility Maintanance")
...
// 	@AT_FM_103
 	@And("User_074 validate the Repayment plan No of Payments should be changed in Facilities Management Maintanance under WIFAK Application")
...
//	@AT_FM_105_FMSCore
    @And("User_074 enter the Application Ref number in Maintanance under WIFAK Facilities Management")
    ...
    @And("User_074 validate Journal Voucher Details option should be visible in Maintanance under WIFAK Facilities Management")
    ...
    @And("User_074 click the Documents Details tab in Maintanance under WIFAK Facilities Management")
    ...
    @And("User_074 enter the row1 Solicitor Date Sent under Document Details in Facilities Management Maintanance")
    ...
    @And("User_074 enter the row1 Solicitor Date Received under Document Details in Facilities Management Maintanance")
    ...
    @And("User_074 enter the row1 Estimator Date Sent under Document Details in Facilities Management Maintanance")
    ...
    @And("User_074 enter the row1 Estimator Date Received under Document Details in Facilities Management Maintanance")
    ...
    @And("User_074 enter the row1 Custodian Date Sent under Document Details in Facilities Management Maintanance")
    ...
    @And("User_074 enter the row2 Solicitor Date Sent under Document Details in Facilities Management Maintanance")
    ...
    @And("User_074 enter the row2 Solicitor Date Received under Document Details in Facilities Management Maintanance")
    ...
    @And("User_074 enter the row2 Estimator Date Sent under Document Details in Facilities Management Maintanance")
    ...
    @And("User_074 enter the row2 Estimator Date Received under Document Details in Facilities Management Maintanance")
    ...
    @And("User_074 enter the row2 Custodian Date Sent under Document Details in Facilities Management Maintanance")
...
//    	System.err.println("Facility Code: "+facilityCode);
    ...
    @And("User_074 enter the Application Ref number in search grid under Approve screen in WIFAK Facilities Management")
    ...
    @And("User_074 enter the Application Ref number in search grid under Update After Approve in WIFAK Facilities Management")
    ...
    @And("User_074 enter the facility rating under Facility Application tab in Update After Approve")
    ...
    @And("User_074 enter the Application Ref number in search grid under Query screen in WIFAK Facilities Management")
    ...
    @And("User_074 enter the Application Ref number in search grid under Suspend screen in WIFAK Facilities Management")
    ...
    @And("User_074 give the Suspend Reason in Suspend screen under WIFAK Facilities Management")
    ...
    @And("User_074 enter the Application Ref number in search grid under Reactivate screen in WIFAK Facilities Management")
    ...
    @And("User_074 enter the Application Ref number in search grid under Reverse screen in WIFAK Facilities Management")
    ...
    @And("User_074 enter the Application Ref number in search grid under Approve\\Reject Reverse screen in WIFAK Facilities Management")
    ...
    @And("User_074 enter the Application Ref number in search grid under Cancel screen in WIFAK Facilities Management")
    ...
    @And("User_074 enter the Application Ref number in search grid under Approve\\Reject Cancel screen in WIFAK Facilities Management")
...
//  @AT_FP_001
    @And("User_074 enter the Floating Rate in limit details")
	...
	@And("User_074 enter the Floating Rate Periodicity in limit details")
	...
	@And("User_074 select the Floating Rate Periodicity type in limit details")
...
//	@AT_DDR_020
	@And("User_074 enter the Down Payment percentage in additional info tab")
...
//		System.out.println("DownPayment Amount: "+downPayment[0]);
	...
	@And("User_074 enter the Down Payment percentage under product class details tab")
	...
	@And("User_074 validate the Down Payment should be correctly in WIFAK Facilities Management Maintanance")
	...
	@And("User_074 validate the Down Payment percentage should be correctly in WIFAK Facilities Management Maintanance")
	...
	@And("User_074 double click the limit details product class row in Facilities Management Maintanance under WIFAK Application")
	...
	@And("User_074 validate the limit details product class Down Payment should be correctly in WIFAK Facilities Management Maintanance")
	...
	@And("User_074 validate the limit details product class Down Payment percentage should be correctly in WIFAK Facilities Management Maintanance")
...
//	@AT_DDR_022
	@And("User_074 Retrieve the Application Code value in Facilities Management Maintanance Screen under WIFAK Application")
	...
	@And("User_074 validate the limit details Floating Rate should be correctlty in WIFAK Facilities Management Maintanance")
	...
	@And("User_074 validate the limit details Floating Rate Periodicity number should be correctlty in WIFAK Facilities Management Maintanance")
	...
	@And("User_074 validate the limit details Floating Rate Periodicity type should be correctlty in WIFAK Facilities Management Maintanance")
	...
	@And("User_074 click the Close button in limit details tab under WIFAK Facilities Management Maintanance")
	public void user_click_the_close_button_in_limit_details_tab_under_wifak_facilities_management_maintanance() throws Throwable {
	 ...
	 @And("^User_074 clicks on the Draw Down request feature under WIFAK Application$")
	    ...
	    @And("^User_074 clicks on the Maintanance under Draw Down request feature in WIFAK Application$")
	    ...
	    @And("^User_074 enter the Facility Reference in main screen under WIFAK Application Draw Down request$")
	    ...
	    @And("^User_074 select the draw down type in main screen under Draw Down request feature$")
	    ...
	    @And("^User_074 enter the Description in main screen under Draw Down request feature$")
	    ...
	    @And("^User_074 enter the value date in maintanance screen under WIFAK Application Draw Down request$")
	    ...
	    @And("User_074 click on the Additional details tab in Draw Down request under WIFAK Application")
	    ...
	    @And("^User_074 select the product class in Additional details tab under Draw Down request$")
	    ...
	    @And("User_074 validate the Floating Rate displayed correctly in Additional details tab under Draw Down request")
	    ...
	    @And("User_074 validate the Floating Rate Periodicity displayed correctly in Additional details tab under Draw Down request")
...
//	    @AT_DDR_023
	    @When("User_074 click the Save button in maintanance under Draw Down request")
	    ...
	    @Then("User_074 click on the Verify\\Deny Menu under WIFAK Draw Down request")
	    ...
	    @And("User_074 enter the DD code in Verify\\Deny search grid under WIFAK Draw down request")
	    ...
	    @And("User_074 double click the DD code in Verify\\Deny search grid under WIFAK Draw down request")
	    ...
	    @And("User_074 click the Verify button in Verify\\Deny under WIFAK Draw down request")
	    ...
	    @Then("User_074 click the Approve\\Reject menu under WIFAK Draw Down request")
	    ...
	    @And("User_074 enter the DD code in Approve\\Reject search grid under WIFAK Draw down request")
	    ...
	    @And("User_074 double click the DD code in Approve\\Reject search grid under WIFAK Draw down request")
	    ...
	    @When("User_074 click the Approve button in Approve\\Reject under WIFAK Draw down request")
...
//	    @AT_DDR_024
	    @And("User_074 click the Clear button in Facilities Management Maintanance under WIFAK Application")
	    ...
	    @Then("User_074 click the Query Menu under WIFAK Draw Down request")
	    ...
	    @And("User_074 enter the DD code in Query search grid under WIFAK Draw down request")
	    ...
	    @And("User_074 double click the DD code in Query search grid under WIFAK Draw down request")
	    ...
	    @And("User_074 click the Additional Details tab in Query Menu under WIFAK Draw Down request")
	    ...
	    @Then("User_074 click the List Menu under WIFAK Draw Down request")
	    ...
	    @And("User_074 enter From code in List menu under WIFAK Draw down request")
	    ...
	    @And("User_074 enter To code in List menu under WIFAK Draw down request")
	    ...
	    @And("User_074 click the Retrieve button in List menu under WIFAK Draw down request")
	    ...
	    @Then("User_074 click the Reverse menu under WIFAK Draw Down request")
	    ...
	    @And("User_074 enter the DD code in Reverse menu search grid under WIFAK Draw down request")
	    ...
	    @And("User_074 double click the DD code in Reverse menu search grid under WIFAK Draw down request")
	    ...
	    @When("User_074 click the Reverse button in Reverse menu under WIFAK Draw down request")
	    ...
	    @Then("User_074 click the Approve\\Reject Reverse menu under WIFAK Draw Down request")
	    ...
	    @And("User_074 enter the DD code in Approve\\Reject Reverse menu search grid under WIFAK Draw down request")
	    ...
	    @And("User_074 double click the DD code in Approve\\Reject Reverse menu search grid under WIFAK Draw down request")
	    ...
	    @When("User_074 click the Approve Reverse button in Approve\\Reject Reverse menu under WIFAK Draw down request")
	    ...
	    @Then("User_074 click the Update After Approve menu under WIFAK Draw Down request")
	    ...
	    @And("User_074 click the clear button in Update After Approve under WIFAK Draw Down request")
	    ...
	    @And("User_074 double click the any one record in Update After Approve under WIFAK Draw Down request")
	    ...
	    @And("User_074 click the Additional Details tab in Update After Approve under WIFAK Draw Down request")
	    ...
	    @And("User_074 edit the FC Amount in Additional Details tab under Update After Approve in WIFAK Draw Down request")
	    ...
	    @When("User_074 click the Save button in Update After Approve under WIFAK Draw Down request")
...
//  @AT_RF_034_FMSCore
	@And("^User_074 search the code in issue facility offer$")
...
//  @AT_RF_040
    @And("^User_074 enter the down payment percentage in additional info under main screen$")
    ...
    @And("^User_074 enter the down payment to vendor percentage in additional info tab$")
...
//  @AT_RF_101_FMSCore
    @And("^User_074 clicks on the document checklist button under limit details$")
    ...
    @And("^User_074 clicks on the add new button under document checklist$")
    ...
    @And("^User_074 give the Document Code under document checklist$")
...
//    	applicationFinancialFacilityObj608.limitDetailsDocumentChecklistDocumentCodeInput_608().sendKeys("3455");
    ...
    @And("^User_074 give the Line No under document checklist$")
    ...
    @And("^User_074 click the Ok button under document checklist$")
...
//    @AT_FM_038_FMSCore
    ...
    @And("User_074 enter the Facility type in search grid under Approval committe recommedations")
    ...
    @And("User_074 select the recommendation as approve in approval committee user popup under Approval committe recommedations")
...
//    	String SuccessMsg = WIFAKapplicationObj608.successPopupMessage().getText();
    ...
    public void user_click_on_the_document_validation_link() {
    	waitHelper.waitForElementwithFluentwait(driver, WIFAKapplicationObj608.FMS_DocumentValidationButton());
    	WIFAKapplicationObj608.FMS_DocumentValidationButton().click();
        
    }

    @And("User_074 Click on Clear button in Document validation page")
    public void user_click_on_clear_button_in_document_validation_page() {
    	waitHelper.waitForElementwithFluentwait(driver, WIFAKapplicationObj608.FMS_DocumentValidation_ClearButton());
    	WIFAKapplicationObj608.FMS_DocumentValidation_ClearButton().click();
        
    }

    @And("User_074 Click on the existing record in document validation page")
    public void user_click_on_the_existing_record_in_document_validation_page() {
    	waitHelper.waitForElementwithFluentwait(driver, WIFAKapplicationObj608.FMS_DocumentValidation_ExistingRecord());
    	WIFAKapplicationObj608.FMS_DocumentValidation_ExistingRecord().click();
        
    }

    @And("User_074 Navigate to Limit details section in Document validation")
    public void user_navigate_to_limit_details_section_in_document_validation() {
    	waitHelper.waitForElementwithFluentwait(driver, WIFAKapplicationObj608.FMS_DocumentValidation_LimitDetailsTab());
    	WIFAKapplicationObj608.FMS_DocumentValidation_LimitDetailsTab().click();
        
    }

    @And("User_074 Select the existing row in limit details section")
    public void user_select_the_existing_row_in_limit_details_section() {
    	waitHelper.waitForElementwithFluentwait(driver, WIFAKapplicationObj608.FMS_DocumentValidation_LimitDetails_ExistingRecord());
    	WIFAKapplicationObj608.FMS_DocumentValidation_LimitDetails_ExistingRecord().click();
        
    }

    @And("User_074 Click on Document checklist button in Document validation")
    public void user_click_on_document_checklist_button_in_document_validation() {
    	waitHelper.waitForElementwithFluentwait(driver, WIFAKapplicationObj608.FMS_DocumentValidation_DocumentChecklistButton());
    	WIFAKapplicationObj608.FMS_DocumentValidation_DocumentChecklistButton().click();
        
    }

    @And("User_074 Validate that user can able to edit values in Document validation page")
    public void user_validate_that_user_can_able_to_edit_values_in_document_validation_page() {
    	waitHelper.waitForElementwithFluentwait(driver, WIFAKapplicationObj608.FMS_DocumentValidation_DocumentChecklist_ExistingRecord());
    	WIFAKapplicationObj608.FMS_DocumentValidation_DocumentChecklist_ExistingRecord().click();
    	WIFAKapplicationObj608.FMS_DocumentValidation_DocumentChecklist_ExistingRecord().clear();
    	WIFAKapplicationObj608.FMS_DocumentValidation_DocumentChecklist_ExistingRecord().sendKeys(testData.get("Document Validation input value"));
    	Assert.assertTrue(!(applicationFinancialFacilityObj608.mainFacilityTypeLabel_608().getAttribute("prevvalue").isBlank()));
