...
//	@AT_FM_035
	@And("User_074 get the test data for test case AT_FM_035_FMSCore")
...
//	@AT_FM_035
	@And("User_074 clicks the Facilities Management feature under Request Financing")
	...
	@And("User_074 clicks the Maintanance in Facilities Management under Request Financing")
	...
	@And("User_074 click the search button in maintanance screen under Facilities Management")
	...
	@And("User_074 search the facility with CIF number in maintanance screen under Facilities Management")
	...
	@Then("User_074 retrieve the facility in maintanance screen under Facilities Management")
...
//  @AT_FM_058
   @And("User_074 select the limit details product class row in under limit details")
   ...
   @And("User_074 click the Repayment Plan button under limit Details in Application Financial Facility Maintanance")
...
//   }
   ...
   @And("User_074 click the Create Schedule button in Repayment Plan tab under Application Financial Facility Maintanance")
   ...
   @And("User_074 validate the Installment Vat Amount in available in Repayment Plan tab under Application Financial Facility Maintanance")
   ...
   @And("User_074 click the Save button in Repayment Plan tab under Application Financial Facility Maintanance")
 ...
 @And("User_074 double click the Application Ref number in Facilities Management Maintanance Search grid under WIFAK Application")
 ...
 @And("User_074 click the Repayment plan button in Facilities Management Maintanance under WIFAK Application")
 ...
 @And("User_074 click the Schedule details tab in Repayment plan tab in Facilities Management Maintanance under WIFAK Application")
 ...
 @Then("User_074 validate Installment Vat amount should be displayed Repayment plan tab under Facilities Management Maintanance")
...
//	@AT_FM_102	
	@And("User_074 click the collect charges per installment on PI approve flag")
	...
	@And("User_074 click the collect charges on deal approve flag")
	...
	@And("User_074 click the collect at facility approval flag")
...
//	@AT_FM_103
	@And("User_074 validate the Repayment plan schedule details should be displayed in Facilities Management Maintanance under WIFAK Application")
	...
	@And("User_074 close the Repament plan tab in Facilities Management Maintanance under WIFAK Application")
	...
	@And("User_074 click the Charges Details button in Facilities Management Maintanance under WIFAK Application")
	...
	@And("User_074 validate the Collect at Fac approval flag should be checked in Facilities Management Maintanance under WIFAK Application")
...
//		System.err.println("Fac Approval Flag: "+ FacApprovalFlag);
	...
	@And("User_074 validate the Collect charges per inst PI approve flag should be checked in Facilities Management Maintanance under WIFAK Application")
...
//		System.err.println("PI Approve Flag: "+ PIApproveFlag);
	...
	@And("User_074 validate the Collect charges on Deal approve flag should be checked in Facilities Management Maintanance under WIFAK Application")
...
//	@AT_FM_104
	@And("User_074 click the Journal voucher details button in Facilities Management Maintanance")
	...
	@Then("User_074 validate Account details should be displayed in JV Details tab under Facilities Management Maintanance")
	...
	@Then("User_074 validate Total Debit value should be displayed in JV Details tab under Facilities Management Maintanance")
	...
	@Then("User_074 validate Total Credit value should be displayed in JV Details tab under Facilities Management Maintanance")
...
//	@AT_FM_105_FMSParam
	@And("^User_074 uncheck the Create Active Facility If Within Limits flag$")
    ...
    @And("^User_074 uncheck the Automatically Approve Facility If Within Limits flag$")
...
//	@AT_FM_105_FMSCore
    ...
    @And("User_074 double click on the search grid first row in Approve screen under WIFAK Facilities Management")
    ...
    @And("User_074 click the Approve button in Approve screen under WIFAK Facilities Management")
    ...
    @And("User_074 click the Update After Approve menu under Facilities Management in WIFAK Application")
    ...
    @And("User_074 double click on the search grid first row in Update After Approve screen under WIFAK Facilities Management")
    ...
    @And("User_074 click the Facility Application tab in Update After Approve under WIFAK Facilities Management")
    ...
    @And("User_074 click the Save button in Update After Approve under WIFAK Facilities Management")
    ...
    @And("User_074 click the Query menu under Facilities Management in WIFAK Application")
    ...
    @And("User_074 double click on the search grid first row in Query screen under WIFAK Facilities Management")
    ...
    @And("User_074 validate the Query menu status should be Active under WIFAK Facilities Management")
    ...
    @And("User_074 again click the Approve menu under Facilities Management in WIFAK Application")
...
//    	applicationFinancialFacilityObj608.WarningPopupOkBtn_608().click();        
    ...
    @And("User_074 click the Suspend menu under Facilities Management in WIFAK Application")
    ...
    @And("User_074 double click on the search grid first row in Suspend screen under WIFAK Facilities Management")
    ...
    @And("User_074 click the Suspend button in Suspend screen under WIFAK Facilities Management")
    ...
    @And("User_074 click the Reactivate menu under Facilities Management in WIFAK Application")
    ...
    @And("User_074 double click on the search grid first row in Reactivate screen under WIFAK Facilities Management")
    ...
    @And("User_074 click the Reactivate button in Reactivate screen under WIFAK Facilities Management")
    ...
    @And("User_074 click the Reverse menu under Facilities Management in WIFAK Application")
    ...
    @And("User_074 double click on the search grid first row in Reverse screen under WIFAK Facilities Management")
    ...
    @And("User_074 click the Reverse button in Reverse screen under WIFAK Facilities Management")
    ...
    @And("User_074 click the Approve\\Reject Reverse menu under Facilities Management in WIFAK Application")
    ...
    @And("User_074 double click on the search grid first row in Approve\\Reject Reverse screen under WIFAK Facilities Management")
    ...
    @And("User_074 click the Reject Reverse button in Approve\\Reject Reverse screen under WIFAK Facilities Management")
    ...
    @And("User_074 click the Cancel menu under Facilities Management in WIFAK Application")
    ...
    @And("User_074 double click on the search grid first row in Cancel screen under WIFAK Facilities Management")
    ...
    @And("User_074 click the Cancel button in Cancel screen under WIFAK Facilities Management")
    ...
    @And("User_074 click the Approve\\Reject Cancel menu under Facilities Management in WIFAK Application")
    ...
    @And("User_074 double click on the search grid first row in Approve\\Reject Cancel screen under WIFAK Facilities Management")
    ...
    @And("User_074 click the Approve Cancel button in Approve\\Reject Cancel screen under WIFAK Facilities Management")
