...
//	@AT_FM_043
	@And("User_074 get the test data for test case AT_FM_043_FMSParam")
	...
	@And("User_074 get the test data for test case AT_FM_043_FMSCore")
...
//    @AT_RF_098_User_074
	@And("^User_074 get the test data for test case AT_RF_098_User_074$")
	public void get_the_test_data_for_test_case_AT_RF_098user2() throws Throwable {
		testData = fmsTransactionsExcelData.getTestdata("DS_AT_RF_098");
	}

//  @AT_RF_157
	@And("User_074 get the test data for test case AT_RF_157")
	...
	public void get_the_test_data_for_test_case_at_faid_011() throws Throwable {
		testData = fmsTransactionsExcelData.getTestdata("DS_AT_FAID_011");
	}
	@And("User_074 get the test data for test case AT_FAID_012")
	public void get_the_test_data_for_test_case_at_faid_012() throws Throwable {
		testData = fmsTransactionsExcelData.getTestdata("DS_AT_FAID_012");
	}
	@And("User_074 get the test data for test case AT_FAM_009")
	public void get_the_test_data_for_test_case_at_fam_009() throws Throwable {
		testData = fmsTransactionsExcelData.getTestdata("DS_AT_FAM_009");
	}
	@And("User_074 get the test data for test case AT_FAM_010")
	public void get_the_test_data_for_test_case_at_fam_010() throws Throwable {
		testData = fmsTransactionsExcelData.getTestdata("DS_AT_FAM_010");
	}
	@And("User_074 get the test data for test case AT_FAM_011")
	public void get_the_test_data_for_test_case_at_fam_011() throws Throwable {
		testData = fmsTransactionsExcelData.getTestdata("DS_AT_FAM_011");
	}
	@And("User_074 get the test data for test case AT_DDR_001")
	public void get_the_test_data_for_test_case_at_ddr_001() throws Throwable {
		testData = fmsTransactionsExcelData.getTestdata("DS_AT_DDR_001");
	}

//	@AT_RF_158_Param
	@And("^User_074 get the test data for test case AT_RF_158_Param$")
...
//	@AT_RF_158_Core
	@And("^User_074 get the test data for test case AT_RF_158_Core$")
...
//	@AT_DDR_025
	@And("^User_074 get the test data for test case AT_DDR_025$")
...
//	@AT_CM_043
	@And("^User_074 get the test data for test case AT_CM_043$")
...
//	@AT_RF_014_IISParam
	@And("^User_074 get the test data for test case AT_RF_014_IISParam$")
...
//	@AT_DDR_021
	@And("^User_074 get the test data for test case AT_DDR_021$")
...
//	@AT_RF_014
	@And("^User_074 clicks on the parameter feature in IIS Param application$")
	...
	@And("^User_074 clicks on the product class module uder parameter feature$")
	...
	@And("^User_074 clicks on the maintanance screen under product class module$")
	...
	@And("^User_074 clicks on the search button in maintanance under product class$")
	...
	@And("^User_074 enter the class code in maintanance under product class$")
...
//    	requestForFinancingObj608.productClassMainSearchClass().sendKeys("1");
	...
	@And("^User_074 double click on the retrived data in maitanance under product class$")
	...
	@And("^User_074 clicks on the additional information tab in maitanance under product class$")
...
//    	requestForFinancingObj608.productClassMainAdditionalInfoTab().click();
	...
	@And("^User_074 clicks on the repayment plan tab under additional information tab$")
	...
	@And("^User_074 enter the value in number of payments under repayment plan tab$")
...
//    	requestForFinancingObj608.repaymentTabNoOfPaymentInput().sendKeys("1");
	...
	@And("^User_074 select the dropdown in number of payments under repayment plan tab$")
...
//    	dropDownHelper.SelectUsingVisibleText(requestForFinancingObj608.repaymentTabNoOfPaymentDropdown(), "Nearest 1");
	...
	@Then("^User_074 clicks save the button in maintanance under product class$")
...
//  AT_RF_014_FMSCore
	@And("^User_074 clicks the limit details first row$")
	...
	@And("^User_074 clicks the repayment plan button under limit details tab$")
	...
	@Then("^User_074 validate the Rounding factor dropdown$")
	...
	@Then("^User_074 validate the No of payments input$")
...
//  @AT_RF_024 -- FMS Param
	@And("^User_074 clicks on the Facility custom fields under Parameter$")
	...
	@And("^User_074 clicks on the Maintain facility custom fields under facility custom fields$")
	...
	@And("^User_074 clicks on the Update after approve in Maintain facility custom fields$")
	...
	@And("^User_074 double click on the one record under update after approve$")
	...
	@And("^User_074 validate Facility Custom Fields screen are available$")
...
//  @AT_RF_034_FMSParam
	@And("^User_074 uncheck the Issue Facility Offer flag$")
	...
	@And("^User_074 move to facility reports tab in update after approve$")
	...
	@And("^User_074 clicks on the search option in issue facility offer under facility reports$")
	...
	@And("^User_074 double click on any one retrived data$")
	...
	@And("^User_074 check the auto print flag under issue facility offer$")
...
//  @AT_RF_034_FMSCore
	@And("^User_074 clicks the issue facility offer under WIFAK Application$")
...
//    	System.out.println("Ref No: "+refID);
	...
	@And("^User_074 double click on the retrived data$")
	...
	@When("^User_074 clicks on the issue offer button under issue facility offer$")
...
//  @AT_RF_035
	@And("^User_074 clicks on the the mortgage management module$")
	...
	@And("^User_074 clicks on the Maintanance screen under mortgage management module$")
	...
	@And("^User_074 verify the Maintanance screen should be arabic language$")
...
//  @AT_RF_040  
	@Then("^User_074 validate the visibility of Account No input box in limit details$")
	...
	@Then("^User_074 validate the visibility of Fund Transfer rate input box in limit details$")
...
//  @AT_RF_098_User_074
	@And("^User_074 clicks on the search button in Application for financial facility main screen$")
	...
	@And("^User_074 search the code in Application for financial facility main screen$")
	...
	@And("^User_074 double click searched record in Application for financial facility main screen$")
	...
	@And("^User_074 clicks on the Approval committee button$")
	...
	@And("^User_074 click the User1 name in Recommented by column$")
	...
	@And("^User_074 clicks on the more comments button$")
	...
	@Then("^User_074 validate the more comments text in input field$")
...
//  @AT_RF_099_FMSParam
	@And("^User_074 clicks the Application Requirements Details option$")
	...
	@And("^User_074 select the collateral as application level$")
	...
	@And("^User_074 select the Collaterals defined at the level of as sublimit$")
	...
	@And("^User_074 validate visibility of Collateral details button under limit details tab$")
...
//  @AT_RF_157
	@And("^User_074 clicks on the Draw Down request module under WIFAK Application$")
	...
	@And("^User_074 clicks on the Maintanance under Draw Down request in WIFAK Application$")
	...
	@And("^User_074 enter the Facility Reference in main screen under WIFAK Draw Down request$")
...
//		}
	...
	@And("^User_074 select the draw down type in main screen under Draw Down request$")
	...
	@And("^User_074 enter the Description in main screen under Draw Down request$")
...
//    	requestForFinancingObj608.drawdownMainDescription().sendKeys("Test");
	...
	@And("User_074 click on the draw down additional details tab")
	...
	@And("^User_074 select the product class in additional screen under Draw Down request$")
	...
	@And("^User_074 give the FC Amount in additional screen under Draw Down request$")
...
//    	requestForFinancingObj608.drawdownAdditionalFCAmount().sendKeys("500",Keys.TAB);
	...
	@And("^User_074 enter the value date in main screen under Draw Down request$")
...
//    	requestForFinancingObj608.drawdownMainValueDate().sendKeys("05/01/2024",Keys.TAB);
	...
	@When("^User_074 click the save button under in maintanance under Draw Down request$")
...
//    	requestForFinancingObj608.drawdownPostApprovalYesBtn_608().click();
	...
	@Then("User_074 click on the Verify link under Draw Down request")
	...
	@And("User_074 click on the clear button in verify under Draw Down request")
	...
	@And("User_074 double click on the code in verify under Draw Down request")
	...
	@When("User_074 click on the verify button in Verify link under Draw Down request")
...
//    	requestForFinancingObj608.drawdownPostApprovalYesBtn().click();
	...
	@Then("User_074 click on the Approve link under Draw Down request")
	...
	@And("User_074 click on the clear button in Approve under Draw Down request")
	...
	@And("User_074 double click on the code in Approve under Draw Down request")
	...
	@When("User_074 click on the Approve button in Approve link under Draw Down request")
	...
	@Then("User_074 again clicks on the Maintanance under Draw Down request")
	...
	@And("User_074 clicks on the search button in main screen under Draw Down request")
	...
	@And("User_074 click the clear button in main screen under Draw Down request")
	...
	@And("User_074 double click on the first line code in main screen under Draw Down request")
	...
	@And("User_074 click on the Status Details button in main screen under Draw Down request")
	...
	@And("User_074 verify the Status Details tab User Name in main screen under Draw Down request")
	public void user_verify_the_status_details_tab_user_name_in_main_screen_under_draw_down_request() throws Throwable {
		...
		System.out.println("User_074 Name: " + userName);
	}

	@Then("User_074 clicks on the Facility Closure Request module")
	...
	@And("User_074 click on the Maintanance under Facility Closure Request module")
	...
	@And("User_074 enter the Facility ref in main screen under Facility Closure Request")
	...
	@And("User_074 enter the Closure reason in main screen under Facility Closure Request")
	...
	@And("User_074 click on the Save button in main screen under Facility Closure Request")
	...
	@Then("User_074 clicks on the Approve under Facility Closure Request module")
	...
	@And("User_074 click on the clear button in approve screen under Facility Closure Request")
	...
	@And("User_074 double click on the code in approve screen under Facility Closure Request")
	...
	@When("User_074 click on the Approve button in approve screen under Facility Closure Request")
	...
	@Then("User_074 again click the Maintanance under Facility Closure Request module")
	...
	@And("User_074 click on the search button in main screen under Facility Closure Request")
	...
	@And("User_074 double click on the code in main screen under Facility Closure Request")
	...
	@And("User_074 click the Status details button in main screen under Facility Closure Request")
	...
	@Then("User_074 verify the Status details tab in main screen under Facility Closure Request")
...
//	@AT_RF_141
	...
	@And("User_074 click the search button under the maintanance screen in Request for Financing")
	...
	@And("User_074 click the clear button under the maintanance screen in Request for Financing")
	...
	@Then("User_074 validate the CIF short Name available under the maintanance screen in Request for Financing")
	...
	@And("User_074 validate the CIF long Name available under the maintanance screen in Request for Financing")
...
//	@AT_RF_141_arabic
	@And("^User_074 click on the language option in FMS core$")
	...
	@And("^User_074 click on the arabic under language option$")
	...
	@And("User_074 clicks on the Funding Request module in arabic")
	...
	@And("User_074 clicks on the Request under Funding Request")
	...
	@And("User_074 clicks on the Funding Request in Request under Funding Request")
	...
	@And("User_074 click the approval committee under Funding Request in Request")
	...
	@Then("User_074 validate the search grid value are displayed in arbic language under approval committee")
...
//	@AT_FM_043_FMSParam
	...
	@And("User_074 select the member as atleast one under Committee approval flag")
...
//	@AT_FM_043_FMSCore	
	...
	@And("User_074 click the Validate button in main screen Request for Financing")
...
//    	requestForFinancingObj608.facilityAlreadyCreatedPopupOkBtn_608().click();
	...
	@Then("User_074 click the approve level1 under Request for Financing")
	...
	@And("User_074 enter the request code in approve level1 under Request for Financing")
	...
	@And("User_074 double click on the first row in approve level1 under Request for Financing")
	...
	@And("User_074 move to customer grading tab in approve level1 under Request for Financing")
	...
	@And("User_074 select the approve level1 recommendation decision as forward in approve level1 under Request for Financing")
	...
	@And("User_074 select the decision forward to as approval committee in approve level1 under Request for Financing")
	...
	@And("User_074 select the approval committee in approve level1 under Request for Financing")
	...
	@And("User_074 click the Approve button in approve level1 under Request for Financing")
	...
	@Then("User_074 click the Approval committee recommendation under Request for Financing")
	...
	@And("User_074 enter the code in Approval committee recommendation under Request for Financing")
	...
	@And("User_074 double click on the first row in Approval committee recommendation under Request for Financing")
	...
	@And("User_074 move to credit committee recommendation tab in approval committee under Request for Financing")
	...
	@And("User_074 click the Recommendation division in credit committee under approval committee")
	...
	@And("User_074 click the plus icon in Recommendation division under credit committee")
	...
	@And("User_074 select the Recommendation dropdown in Recommendation division under credit committee")
	...
	@When("User_074 click the Recommendation button under Approval committee recommendation")
...
//	@AT_DDR_021
	@And("User_074 enter the Down Payment Percentage in main screen under Request for Financing")
	...
	@And("User_074 enter the product class Down Payment Percentage in limit details tab under sublimit tab")
	...
	@And("User_074 select the approve level1 recommendation decision as approve in approve level1 under Request for Financing")
	...
	@And("User_074 validate the Down Payment percentage should be correctly in approve level1 under Request for Financing")
...
//  @AT_RF_101_FMSParam
	@And("^User_074 clicks on the Document checklist feature$")
	...
	@And("^User_074 clicks on the update after approve menu in Document checklist$")
	...
	@And("^User_074 retrive the one data in update after approve in Document checklist$")
	...
	@And("^User_074 click the add new button under update after approve in Document checklist$")
	...
	@And("^User_074 add the new record under Document details in update after approve$")
	...
	@And("^User_074 clicks on the update button under the update after approve in Document checklist$")
	...
	@And("^User_074 move to the approve menu under Document checklist$")
	...
	@And("^User_074 retrive the first data in approve under Document checklist$")
	...
	@And("^User_074 clicks on the Approve button under approve in Document checklist$")
	...
	@And("^User_074 clicks on the Document management tab in update after approve menu$")
	...
	@And("^User_074 check the Application creation checkbox under Document management tab$")
...
//  @AT_RF_158_Param
	@And("^User_074 clicks on the Collateral type module$")
	...
	@And("^User_074 clicks on the Maintanance screen under Collateral type$")
	...
	@And("^User_074 enter the code under Collateral Type main screen$")
...
//    	requestForFinancingObj608.collateralTypeMainCode_608().sendKeys("1260");
	...
	@And("^User_074 enter the Brief description under Collateral Type main screen$")
...
//    	requestForFinancingObj608.collateralTypeMainBriefDescrip_608().sendKeys("Test1");
	...
	@And("^User_074 enter the Long description under Collateral Type main screen$")
...
//    	requestForFinancingObj608.collateralTypeMainLongDescrip_608().sendKeys("Test1");
	...
	@And("^User_074 select the Asset type as cash under Collateral Type main screen$")
...
//    	dropDownHelper.SelectUsingVisibleText(requestForFinancingObj608.collateralTypeMainAssetTypeDropdown_608(), "Cash");
	...
	@When("^User_074 clicks on the save button under Collateral Type main screen$")
	...
	@And("^User_074 clicks on the Approve screen under Collateral Type$")
	...
	@And("^User_074 search the code under Collateral Type approve screen$")
...
//    	requestForFinancingObj608.collateralTypeApproveCode_608().sendKeys("1260");
	...
	@And("^User_074 double click on the searched result under Collateral Type approve screen$")
	...
	@When("^User_074 clicks on the Approve button under Collateral Type approve screen$")
...
//    	requestForFinancingObj608.CollateralCashDetailsAmount_608().sendKeys("1000");
	...
	@And("^User_074 click the clear button under approve screen in Collateral Management$")
	...
	@And("^User_074 double click on the first row in approve screen$")
...
//  @AT_DDR_025
	@And("User_074 select the application for dropdown as new facility under Application for financial facility")
	...
	@And("User_074 enter the CIF No in main info tab in Application for financial facility Maintanance")
	...
	@And("User_074 validate the CIF status displayed should be blacklist under Application for financial facility")
...
//    	System.err.println("CIF Blacklist Message: "+CIFblacklistMsg);
	...
	@And("User_074 enter the CIF No under main information in Collateral Management main Screen")
	...
	@And("User_074 validate the CIF status displayed should be blacklist under Collateral Management maintanance")
...
//    	System.err.println("CIF Blacklist Message in Collateral: "+CIFblacklistMsg);
	...
	public void user_select_the_existing_facility_number_under_main_screen_in_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver,
				requestForFinancingObj608.RequestForFinancing_ExistingFacilityNoField());
		requestForFinancingObj608.RequestForFinancing_ExistingFacilityNoField().sendKeys(testData.get("Existing Facility No"),
				Keys.TAB);
	    
	}

	@And("User_074 Update the total limit value under main screen in Request for Financing")
	public void user_update_the_total_limit_value_under_main_screen_in_request_for_financing() {
		waitHelper.waitForElementwithFluentwait(driver,
				requestForFinancingObj608.requestForFinancingMainTotalLimitInput_608());
		requestForFinancingObj608.requestForFinancingMainTotalLimitInput_608().click();
		requestForFinancingObj608.requestForFinancingMainTotalLimitInput_608().clear();
		requestForFinancingObj608.requestForFinancingMainTotalLimitInput_608().sendKeys(testData.get("UpdatedTotalLimit"),
				Keys.TAB);
	    
	}

	@And("User_074 Validate that updated limit value is reflected in sublimit tab")
	public void user_validate_that_updated_limit_value_is_reflected_in_sublimit_tab(){
		waitHelper.waitForElementwithFluentwait(driver,
				requestForFinancingObj608.RequestForFinancing_ExistingValueInSublimitSection());
		String totallimit = requestForFinancingObj608.RequestForFinancing_ExistingValueInSublimitSection().getText();
        Assert.assertEquals(testData.get("UpdatedTotalLimit"),totallimit.split("[.]")[0].replace(",", ""));
	}
	@And("User_074 Validate the Document validation field is displayed under STP Facility Requirements")
	public void user_validate_the_document_validation_field_is_displayed_under_stp_facility_requirements() {
		waitHelper.waitForElementwithFluentwait(driver, requestForFinancingObj608.Param_FacilityType_DocumentValidationFieldText());
		boolean documentvalidation = requestForFinancingObj608.Param_FacilityType_DocumentValidationFieldText().isDisplayed();
		Assert.assertEquals(true, documentvalidation);
	}
	@And("User_074 Select the value in Revolving Oneoff dropdown")
	public void user_select_the_value_in_revolving_oneoff_dropdown() {
		waitHelper.waitForElementwithFluentwait(driver,
				requestForFinancingObj608.RequestForFinancing_REvolvingOneoffDropdown());
		dropDownHelper.SelectUsingVisibleText(requestForFinancingObj608.RequestForFinancing_REvolvingOneoffDropdown(),
				testData.get("Revolving OneOff Value"));
	}
	@And("User_074 Validate that Expiration date field is displayed")
	public void user_validate_that_expiration_date_field_is_displayed() {
		waitHelper.waitForElementwithFluentwait(driver, requestForFinancingObj608.RequestForFinancing_ExpirationDateField());
		boolean expirationdatefield = requestForFinancingObj608.RequestForFinancing_ExpirationDateField().isDisplayed();
		Assert.assertEquals(true, expirationdatefield);
	}
...
//		requestForFinancingObj608.wifakFacilitiesManagementMainCollateralDetailsTabAddIcon_608().click();
	...
	@And("User_074 enter the Application Ref code in search grid under Approve screen in WIFAK Facilities Management")
