...
@AT_AE_012
Scenario: Check the saved record is available in the approve screen and user can able to select and unselect the records which are need to be approve and approve the selected record successfully
