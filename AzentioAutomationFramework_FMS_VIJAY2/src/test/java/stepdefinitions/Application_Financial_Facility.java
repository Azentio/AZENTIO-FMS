...
import pageobjects.Application_Financial_Facility_Pageobjects;
...
*/
	...
	/*
	 * @And("^Update the test data set id for TC_127780$") public void
	 * update_the_test_data_set_id_for_tc127780() throws Throwable { testData =
	 * FmsParamsApplicationFacility.getTestdata("TC_127780_D1"); }
	 */
    ...
    public void check_the_apply_corporate_package_are_displayed() throws Throwable {
		...
		try {
			Assert.assertTrue(applicationFinancialObj.FacilityType_UpdateAfterApprove_FacilityDetails_ApplicationRequirementsandDetails_ApplyCorporatePackage().isEnabled());
		} catch (Exception e) {
    ...
    public void check_the_allow_to_edit_corporate_package_rate_csm_are_displayed() throws Throwable {
    	...
    	try {
			Assert.assertTrue(applicationFinancialObj.FacilityType_UpdateAfterApprove_FacilityDetails_ApplicationRequirementsandDetails_AllowtoeditCorporatePackageRate().isEnabled());	
		} catch (Exception e) {
			Assert.fail(e.getMessage());
		}
    }
    ...
    public void check_the_allow_to_edit_application_are_displayed() throws Throwable {
    	...
    	try {
    		Assert.assertTrue(applicationFinancialObj.FacilityType_UpdateAfterApprove_FacilityDetails_ApplicationRequirementsandDetails_AllowtoEditApplication().isEnabled());
		} catch (Exception e) {
			Assert.fail(e.getMessage());
		}
    }	
    ...
    @Then("^Select the Revolving/One-Off option in Main Details tab$")
    public void select_the_revolvingoneoff_option_in_main_details_tab() throws Throwable {
		...
		clicksAndActionHelper.clickOnElement(applicationFinancialObj.FacilityType_UpdateAfterApprove_RevolvingOneOff());
    }

    @Then("^Enter the value for Max Revolving Times$")
    public void enter_the_value_for_max_revolving_times() throws Throwable {
    ...
    @Then("^Enable the Subject to Full Repayment$")
    public void enable_the_subject_to_full_repayment() throws Throwable {
    	...
    	try {
			if(applicationFinancialObj.FacilityType_UpdateAfterApprove_SubjecttoFullRepayment().isEnabled()){
				Assert.assertTrue(applicationFinancialObj.FacilityType_UpdateAfterApprove_SubjecttoFullRepayment().isEnabled());
			}
			else {
    ...
    @Then("^Click the Code in Approve screen$")
    public void click_the_code_in_approve_screen() throws Throwable {
    	waitHelper.waitForElementwithFluentwait(driver, applicationFinancialObj.FacilityType_Approve_SelectCode());
		clicksAndActionHelper.moveToElement(applicationFinancialObj.FacilityType_Approve_SelectCode());
    ...
    public void enable_the_apply_revolving_controls_in_main_details_tab() throws Throwable {
		...
		try {
			if(applicationFinancialObj.FacilityType_UpdateAfterApprove_ApplyRevolvingControls().isEnabled()){
				Assert.assertTrue(applicationFinancialObj.FacilityType_UpdateAfterApprove_ApplyRevolvingControls().isEnabled());
			}
			else {
    ...
    public void enter_the_value_for_manual_revolving_minimum_utilization() throws Throwable {
    ...
    public void search_for_the_code_in_approve_screen() throws Throwable {
    	waitHelper.waitForElementwithFluentwait(driver, applicationFinancialObj.FacilityType_Approve_Code());
		clicksAndActionHelper.moveToElement(applicationFinancialObj.FacilityType_Approve_Code());
		clicksAndActionHelper.clickOnElement(applicationFinancialObj.FacilityType_Approve_Code());
