...
public class CommonElementsObj {
	...
	private WebElement iis_Error_Pop_up_Text;

	public WebElement iisErrorPopupText() {
		return iis_Error_Pop_up_Text;
	}
	
	
	@FindBy(xpath = "//span[normalize-space()='Close']")
	private WebElement Running_Date_Box_Close_Btn;

	public WebElement RunningDateBoxCloseBtn() {
		return Running_Date_Box_Close_Btn;
	}
