...
import resources.BaseClass;
	...
	public class IISSettlementStepDef {
		...
		@And("^user get the test data for test case AT_SETLMNT_018$")
		public void user_get_the_test_data_for_test_case_AT_SETLMNT_018() {
			testData = excelData.getTestdata("AT_SETLMNT_018_D1");
		}
		
		@Then ("^user click on the parameter tab under menu$")
		public void user_click_on_the_parameter_tab_under_menu(){
			waitHelper.waitForElementwithFluentwait(driver, iisCommonElements.iisParametertab());
			iisCommonElements.iisParametertab().click();
		}
		...
		@Then ("^user 021 click on the batch settlement under settlement$")
		...
		public void user_021_enter_the_settlement_date(){waitHelper.waitForElementwithFluentwait(driver, settlementObj.BatchSettlementDate());
