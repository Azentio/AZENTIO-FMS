...
@AT_AFF_103
Scenario: Check the attached scenarios in Application and Request screens
Given navigate to FMS application and login with valid credentials
...
@AT_AFF_105
Scenario: Check the new field "Profit Rate" functionality in Application screen with Validation Type as Warning in “IP/BP/Tenure” matrix parameter screen
Given navigate to FMS application and login with valid credentials
...
@AT_AFF_106
Scenario: Check the new field "Profit Rate" functionality in Application screen with Validation Type as Stopping in “IP/BP/Tenure” matrix parameter screen
Given navigate to FMS application and login with valid credentials
And User_482 Click on App Screen Application Main Menu
And User_482 Click on App Screen Application Sub Menu
And User_482 Click Application for financial facilities for App Screen 
