...
public class IISLogin {	
	...
	ExcelData mtsLoginExceldata = new ExcelData(TestDataPath, "MTS_Login", "UserType");
...
//	}
	...
	public void loginIntoMTSApplication2(String userType) {
		iisLoginTestData = mtsLoginExceldata.getTestdata(userType);
		iisCommonElements = new IISCommonElements(driver);
		clicksAndActionHelper = new ClicksAndActionsHelper(driver);
		waitHelper.waitForElementwithFluentwait(driver, iisCommonElements.iisUserName());
		iisCommonElements.iisUserName().click();
	...
	public void loginIntoMTSApplication(String userType) {
		...
		/*
		 * waitHelper.waitForElementwithFluentwait(driver,
		 * iisCommonElements.fmsLogoutButton());
		 * clicksAndActionHelper.moveToElement(iisCommonElements.fmsLogoutButton());
		 * clicksAndActionHelper.clickOnElement(iisCommonElements.fmsLogoutButton());
		 * waitHelper.waitForElementwithFluentwait(driver,
		 * iisCommonElements.fmsUserName());
		 * Assert.assertTrue(iisCommonElements.fmsUserName().isDisplayed());
		 * driver.quit();
		 */
	}
