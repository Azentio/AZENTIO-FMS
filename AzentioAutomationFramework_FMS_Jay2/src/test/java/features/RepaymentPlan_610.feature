  ...
  Scenario: ABSAI180125 - NBADAD150027 - Cannot view Repayment Plan schedule once limit line is deleted & re-inserted
   ...
   #retrive Application for financial facilities screen
    ...
    When User_610 clicks on the level3 submit button
	 ...
	 And User_610 click limits deteils in Approval Committee Recommendations Menu
	 And User_610 click Product Class in Approval Committee Recommendations Menu
	 And User_610 Validate FloatingRate key is Enable or Not in Approval Committee Recommendations Menu
	 And User_610 Validate FloatingRate Periodicity key is Enable or Not in Approval Committee Recommendations Menu
	 And User_610 Validate FloatingRate Periodicity Type key is Enable or Not in Approval Committee Recommendations Menu
