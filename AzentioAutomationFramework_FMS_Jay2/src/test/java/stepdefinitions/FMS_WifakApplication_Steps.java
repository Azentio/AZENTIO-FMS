...
public class FMS_WifakApplication_Steps {
	...
	//	clicksAndActionsHelper.clickOnElement(FMSWifakErrorWhileSavingObj.getApplication_for());
		DropDownhelper.SelectUsingVisibleText(FMSWifakErrorWhileSavingObj.getApplication_for(),testData.get("Application For"));
	...
	public void search_cif_no() {
		...
		FMSWifakErrorWhileSavingObj.getCIF_no().sendKeys(Keys.TAB);
	}
	...
	public void enter_codeon_facility_type() throws Throwable {
		...
		FMSWifakErrorWhileSavingObj.getEnter_codeOn_Facility_Type().sendKeys(Keys.TAB);
...
//		FMSWifakErrorWhileSavingObj.getEnter_ValueOn_Product_Class().sendKeys("1");
	...
	public void click_search_button_in_account_no() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, FMSWifakErrorWhileSavingObj.Click_Search_Button_Account_No());
	...
	public void enter_double_click_search_account_no() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, FMSWifakErrorWhileSavingObj.Double_Click_Search_Account_No());
	...
	public void click_fixed_assert_button() throws Throwable {
		// waitHelper.waitForElementwithFluentwait(driver,
		// FMSWifakErrorWhileSavingObj.getClick_FixedAssert_Button());
	...
	public void enter_value_on_catagory() throws Throwable {
		// waitHelper.waitForElementwithFluentwait(driver,
		// FMSWifakErrorWhileSavingObj.getEnter_value_on_Catagory());
...
//				FMSWifakErrorWhileSavingObj.getEnter_value_on_Catagory().click();
	...
	public void enter_value_on_vat_code() throws Throwable {
		for (int i = 0; i < 200; i++) {
			try {
				JavascriptHelper.scrollIntoView(FMSWifakErrorWhileSavingObj.Enter_value_on_Vat_Code());
				clicksAndActionsHelper.moveToElement(FMSWifakErrorWhileSavingObj.Enter_value_on_Vat_Code());
	...
	public void user_check_flag_in_collect_at_fac_approvel() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.Check_Flag_In_Collect_At_Fac_Approvel());
	...
	public void user_click_ok_button_in_collect_at_fac_approvel() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.Click_Ok_Button_In_Collect_At_Fac_Approvel());
...
//			clicksAndActionsHelper.doubleClick(FMSWifakErrorWhileSavingObj.EnterTheValue_Solicitor_Name());
		...
		for (int i = 0; i < 1000; i++) {
			try {
				...
				FMSWifakErrorWhileSavingObj.EnterTheValue_Solicitor_Name().sendKeys(testData.get("Solicitor Name"));
				break;
			} catch (Exception e) {
				if (i == 199) {
					Assert.fail(e.getMessage());
...
//			clicksAndActionsHelper.doubleClick(FMSWifakErrorWhileSavingObj.EnterTheValue_Estimator_Name());
		...
		for (int i = 0; i < 1000; i++) {
			try {
				...
				FMSWifakErrorWhileSavingObj.EnterTheValue_Estimator_Name().sendKeys(testData.get("Estimator Name"));
				break;
			} catch (Exception e) {
				if (i == 199) {
					Assert.fail(e.getMessage());
...
//			clicksAndActionsHelper.clickOnElement(FMSWifakErrorWhileSavingObj.Validate_Warning_ConfirmValidateProcess());
		...
		for (int i = 0; i < 2000; i++) {
			try {
				// waitHelper.waitForElementwithFluentwait(driver,
				// FMSWifakErrorWhileSavingObj.Validate_Warning_ConfirmValidateProcess());
...
//			clicksAndActionsHelper.clickOnElement(FMSWifakErrorWhileSavingObj.Validate_Confirm_alreadyCreated());
	...
	public void click_ok_button_in_success_validate_successfully_in_document_details() {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.Validate_Success_ValidateSuccessfull());
		...
		for (int i = 0; i < 2000; i++) {
			try {
				...
				clicksAndActionsHelper
						.clickOnElement(FMSWifakErrorWhileSavingObj.Validate_Success_ValidateSuccessfull());
			} catch (Exception e) {
				if (i == 199) {
					Assert.fail(e.getMessage());
				}
...
//			clicksAndActionsHelper.clickOnElement(FMSWifakErrorWhileSavingObj.Validate_SendAlert_Dismiss());
		...
		for (int i = 0; i < 2000; i++) {
			try {
				// waitHelper.waitForElementwithFluentwait(driver,
				// FMSWifakErrorWhileSavingObj.Validate_SendAlert_Dismiss());
				clicksAndActionsHelper.clickOnElement(FMSWifakErrorWhileSavingObj.Validate_SendAlert_Dismiss());
			} catch (Exception e) {
				if (i == 199) {
					Assert.fail(e.getMessage());
...
//		}
		...
		// String SuccessMsg =
		// FMSWifakErrorWhileSavingObj.successPopupMessage().getText();
	...
	public void enter_holiday_date_in_expiratin_date_in_additional_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.Expiratin_date_additional_Details());
	...
	public void confirm_the_requested_holiday_date() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.Confirm_theRequested_Holiday_date());
	...
	public void enter_holiday_date_in_expected_payment_date_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.ExpectedPaymenDate_inLimitDetails_SubMenu());
	...
	public void confirm_the_requested_holiday_date_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.Confirm_theRequested_Holiday_date_In_LimitsDetails());
		clicksAndActionsHelper
				.moveToElement(FMSWifakErrorWhileSavingObj.Confirm_theRequested_Holiday_date_In_LimitsDetails());
		clicksAndActionsHelper
				.clickOnElement(FMSWifakErrorWhileSavingObj.Confirm_theRequested_Holiday_date_In_LimitsDetails());
	}
	...
	public void check_the_level_of_product_class_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.ProductClass_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_case_non_case_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.CaseNonCase_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_exchange_rate_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.ExchangeRate_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_down_payment_percentage_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.DownPaymentPercentage_InLImitDetails_SubMenu());
		clicksAndActionsHelper
				.moveToElement(FMSWifakErrorWhileSavingObj.DownPaymentPercentage_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.DownPaymentPercentage_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_details_down_payment_to_vendor_percentage_in_limit_details_submenu()
			throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.DownPaymentToVendorPerc_InLImitDetails_SubMenu());
		clicksAndActionsHelper
				.moveToElement(FMSWifakErrorWhileSavingObj.DownPaymentToVendorPerc_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.DownPaymentToVendorPerc_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_total_down_payment_percentage_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.TotalDownPaymentPerc_InLImitDetails_SubMenu());
		clicksAndActionsHelper.moveToElement(FMSWifakErrorWhileSavingObj.TotalDownPaymentPerc_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.TotalDownPaymentPerc_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_total_facility_value_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.TotalFacilityValue_InLImitDetails_SubMenu());
		clicksAndActionsHelper.moveToElement(FMSWifakErrorWhileSavingObj.TotalFacilityValue_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.TotalFacilityValue_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_facility_value_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.FacilityValue_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_down_payment_amountin_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.DownPaymentAmount_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_down_payment_to_vendor_amt_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.DownPaymentToVendorAmt_InLImitDetails_SubMenu());
		clicksAndActionsHelper
				.moveToElement(FMSWifakErrorWhileSavingObj.DownPaymentToVendorAmt_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.DownPaymentToVendorAmt_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_total_down_payment_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.TotalDownPayment_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_maturity_date_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.Maturity_Date_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_account_name_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.AccountName_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_tfa_margin_ratein_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.TFAMarginRate_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_sub_eco_sector_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.SubEcoSector_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_discounting_margin_percentage_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.DiscountingMarginPer_InLImitDetails_SubMenu());
		clicksAndActionsHelper.moveToElement(FMSWifakErrorWhileSavingObj.DiscountingMarginPer_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.DiscountingMarginPer_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_payment_method_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.PaymentMethod_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_installment_amount_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.InstallmentAmount_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_security_deposit_amount_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.SecurityDepositAmount_InLImitDetails_SubMenu());
		clicksAndActionsHelper
				.moveToElement(FMSWifakErrorWhileSavingObj.SecurityDepositAmount_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.SecurityDepositAmount_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_floor_rate_method_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.floorRateMethod_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_credit_spread_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.CreditSpread_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_sublimit_lower_limit_amount_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.SublimitLowerLimitAmount_InLImitDetails_SubMenu());
		clicksAndActionsHelper
				.moveToElement(FMSWifakErrorWhileSavingObj.SublimitLowerLimitAmount_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.SublimitLowerLimitAmount_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_expected_payment_date_in_limit_details_submenu() throws Throwable {
		...
		clicksAndActionsHelper.moveToElement(FMSWifakErrorWhileSavingObj.ExpectedPaymenDate_inLimitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.ExpectedPaymenDate_inLimitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_checking_on_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.CheckingOn_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_fund_transfer_rate_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.FundTransferRate_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_tfat_enure_days_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.TFATenureDays_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_purpose_of_financing_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.Purposeoffinancing_InLImitDetails_SubMenu());
		clicksAndActionsHelper.moveToElement(FMSWifakErrorWhileSavingObj.Purposeoffinancing_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.Purposeoffinancing_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_no_of_installments_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.NoofInstallments_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_amended_security_deposit_amount_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.AmendedSecurityDepositAmount_InLImitDetails_SubMenu());
		clicksAndActionsHelper
				.moveToElement(FMSWifakErrorWhileSavingObj.AmendedSecurityDepositAmount_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.AmendedSecurityDepositAmount_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_selling_price_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.selling_price_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_floor_rate_percentage_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.FloorRatePercentage_InLImitDetails_SubMenu());
		clicksAndActionsHelper.moveToElement(FMSWifakErrorWhileSavingObj.FloorRatePercentage_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.FloorRatePercentage_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_sublimit_lower_limit_percentage_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.SublimitLowerLimitPerc_InLImitDetails_SubMenu());
		clicksAndActionsHelper
				.moveToElement(FMSWifakErrorWhileSavingObj.SublimitLowerLimitPerc_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.SublimitLowerLimitPerc_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_revolving_one_off_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.RevolvingOneOff_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_penalty_on_due_amount_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.PenaltyOnDueAmount_InLImitDetails_SubMenu());
		clicksAndActionsHelper.moveToElement(FMSWifakErrorWhileSavingObj.PenaltyOnDueAmount_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.PenaltyOnDueAmount_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_charges_type_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.chargestype_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_comments_and_conditions_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.comments_and_conditions_InLImitDetails_SubMenu());
		clicksAndActionsHelper
				.moveToElement(FMSWifakErrorWhileSavingObj.comments_and_conditions_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.comments_and_conditions_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_maximum_tenure_periodicity_no_key_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.MaximumTenure_PeriodicityNo_key_InLImitDetails_SubMenu());
		clicksAndActionsHelper
				.moveToElement(FMSWifakErrorWhileSavingObj.MaximumTenure_PeriodicityNo_key_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.MaximumTenure_PeriodicityNo_key_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_minimum_tenure_periodicity_no_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.MinimumTenure_PeriodicityNo_InLImitDetails_SubMenu());
		clicksAndActionsHelper
				.moveToElement(FMSWifakErrorWhileSavingObj.MinimumTenure_PeriodicityNo_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.MinimumTenure_PeriodicityNo_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_maximum_tenure_for_financing_periodicityno_key_in_limit_details_submenu()
			throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.MaximumTenureforfinancing_PeriodicityNo_key_InLImitDetails_SubMenu());
		clicksAndActionsHelper.moveToElement(
				FMSWifakErrorWhileSavingObj.MaximumTenureforfinancing_PeriodicityNo_key_InLImitDetails_SubMenu());
		Assert.assertEquals(true, FMSWifakErrorWhileSavingObj
				.MaximumTenureforfinancing_PeriodicityNo_key_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_floating_rate_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.FloatingRate_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_floating_rate_periodi_city_type_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.FloatingRatePeriodicityType_InLImitDetails_SubMenu());
		clicksAndActionsHelper
				.moveToElement(FMSWifakErrorWhileSavingObj.FloatingRatePeriodicityType_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.FloatingRatePeriodicityType_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_total_yield_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.TotalYield_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_limit_lip_start_dat_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.limitlipstartdate_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_zero_entry_cost_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.zeroentrycost_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_apply_penaltyin_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.ApplyPenalty_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_grace_period_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.GracePeriod_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_regimental_agent_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.REGIMENTAL_AGENT_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_contracted_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.CONTRACTED_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_transaction_cy_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.transaction_cy_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_maximum_tenure_periodicity_type_key_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.MaximumTenure_PeriodicityType_key_InLImitDetails_SubMenu());
		clicksAndActionsHelper
				.moveToElement(FMSWifakErrorWhileSavingObj.MaximumTenure_PeriodicityType_key_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.MaximumTenure_PeriodicityType_key_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_minimum_tenure_periodicitytype_key_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.MinimumTenure_PeriodicityType_key_InLImitDetails_SubMenu());
		clicksAndActionsHelper
				.moveToElement(FMSWifakErrorWhileSavingObj.MinimumTenure_PeriodicityType_key_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.MinimumTenure_PeriodicityType_key_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_maximum_tenure_for_financing_periodicitytype_key_in_limit_details_submenu()
			throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.MaximumTenureforfinancing_PeriodicityType_key_InLImitDetails_SubMenu());
		clicksAndActionsHelper.moveToElement(
				FMSWifakErrorWhileSavingObj.MaximumTenureforfinancing_PeriodicityType_key_InLImitDetails_SubMenu());
		Assert.assertEquals(true, FMSWifakErrorWhileSavingObj
				.MaximumTenureforfinancing_PeriodicityType_key_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_floating_rate_periodi_city_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.FloatingRatePeriodicit_InLImitDetails_SubMenu());
		clicksAndActionsHelper
				.moveToElement(FMSWifakErrorWhileSavingObj.FloatingRatePeriodicit_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.FloatingRatePeriodicit_InLImitDetails_SubMenu().isDisplayed());
	}
	...
	public void check_the_level_of_margin_rate_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.MarginRate_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_lip_perioin_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.lip_period_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_lip_period_amende_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.lip_period_amende_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_transcation_type_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.TranscationType_InLImitDetails_SubMenu());
	...
	public void check_the_level_of_transcation_maturity_in_limit_details_submenu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.TranscationMaturity_InLImitDetails_SubMenu());
		clicksAndActionsHelper.moveToElement(FMSWifakErrorWhileSavingObj.TranscationMaturity_InLImitDetails_SubMenu());
		Assert.assertEquals(true,
				FMSWifakErrorWhileSavingObj.TranscationMaturity_InLImitDetails_SubMenu().isDisplayed());
	}
...
//			clicksAndActionsHelper.clickOnElement(FMSWifakErrorWhileSavingObj.getMaintenance());
	...
	public void enter_down_payment_in_percentage() throws Throwable {
		...
		for (int i = 0; i <= 500; i++) {
			try {
				if (FMSWifakErrorWhileSavingObj.DownPaymentAmo_InLImitDetails_SubMenu().getAttribute("prevvalue")
						.isBlank()) {
					break;
				}
			} catch (Exception e) {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.DownPaymentAmo_InLImitDetails_SubMenu());
		String attribute = FMSWifakErrorWhileSavingObj.DownPaymentAmo_InLImitDetails_SubMenu()
...
//			clicksAndActionsHelper.clickOnElement(FMSWifakErrorWhileSavingObj.CLEAN_FLAG_In_LimitsDetails());
		...
		waitHelper.waitForElementwithFluentwait(driver, FMSWifakErrorWhileSavingObj.FRRValueDate_In_LimitsDetails());
		FMSWifakErrorWhileSavingObj.FRRValueDate_In_LimitsDetails().sendKeys("04/01/2021");
	}
	...
	public void click_repayment_plan_in_limits_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.RepaymentPlan_btn_In_LimitsDetails());
...
//---------------------approvel 1	    
	...
	public void user_clicks_the_approve_level1_link() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.applicationFinancialFacilityApproveLevel1());
	...
	public void user_retrive_the_first_data_in_approve_level1() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.Enter_ValidateCode_approve_level1());
//	    	FMSWifakErrorWhileSavingObj.approve1ClearBtn().click();
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.ClickTheValue_ValidateCode_approve_level1());
	...
	public void select_the_approve_level1_decision_as_approve() throws Throwable {
		...
		// DropDownhelper.SelectUsingVisibleText(FMSWifakErrorWhileSavingObj.approveLevel1SelectDevision(),
	...
	public void user_clicks_the_approve_level2_link() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.applicationFinancialFacilityApproveLevel2());
	...
	public void user_retrive_the_first_data_in_approve_level2() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.Enter_ValidateCode_approve_level2());
//	    	FMSWifakErrorWhileSavingObj.approve1ClearBtn().click();
		FMSWifakErrorWhileSavingObj.Enter_ValidateCode_approve_level2().sendKeys(SuccessMsg, Keys.ENTER);

		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.ClickTheValue_ValidateCode_approve_level2());
	...
	public void user_select_the_level2_decision_as_approve() throws Throwable {
		...
		// DropDownhelper.SelectUsingVisibleText(FMSWifakErrorWhileSavingObj.approveLevel2SelectDecision(),
	...
	public void user_clicks_the_approve_level3_link() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.applicationFinancialFacilityApproveLevel3());
	...
	public void user_retrive_the_first_data_in_approve_level3() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.Enter_ValidateCode_approve_level3());
//	    	FMSWifakErrorWhileSavingObj.approve1ClearBtn().click();
		FMSWifakErrorWhileSavingObj.Enter_ValidateCode_approve_level3().sendKeys(SuccessMsg, Keys.ENTER);

		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.ClickTheValue_ValidateCode_approve_level3());
	...
	public void user_select_the_level3_decision_as_approve() throws Throwable {
		...
		// DropDownhelper.SelectUsingVisibleText(FMSWifakErrorWhileSavingObj.approveLevel3SelectDecision(),
	...
	public void retrive_one_data_in_update_after_approvel_screen() {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.clearButton_InUpdateApproveScreen());
		for (int i = 0; i < 2000; i++) {
			try {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.retriveData_InUpdateApproveScreen());
	...
	public void click_facility_application_details() {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.facilityApplicationDetails_InUpdateApproveScreen());
	...
	public void check_flag_exceed_facility_at_sublimit() {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.exceedFacilityAtSublimit_InUpdateApproveScreen());
	...
	public void check_flag_subject_to_full_repayment() {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.subjectTofullRepayment_InUpdateApproveScreen());
	...
	public void click_facility_limit_details() {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.facilityLimitDetails_InUpdateApproveScreen());
	...
	public void click_product_class() {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.productClass_InfacilityLimitDetails_InUpdateApproveScreen());
		clicksAndActionsHelper
				.doubleClick(FMSWifakErrorWhileSavingObj.productClass_InfacilityLimitDetails_InUpdateApproveScreen());
	}

	@Given("User_610 enter the value cap rate")
	public void enter_the_value_cap_rate() {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.capRate_InLimitDetails_InUpdateApproveScreen());
	...
	public void enter_the_value_selling_price() {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.sellingPrice_InLimitDetails_InUpdateApproveScreen());
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.EditBUtton_InLimitDetails_InUpdateApproveScreen());
	...
	public void click_document_details_approvel_screen() {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.documentDetails_InUpdateApproveScreen());
	...
	public void enter_the_date_in_document_details() {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.clickfirstRow1buttonButton_InDocumentDetails());
		FMSWifakErrorWhileSavingObj.clickfirstRow1buttonButton_InDocumentDetails().click();

		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.solicitorDataSend_InDocumentDetails());
		...
		for (int i = 0; i <= 500; i++) {
			try {
				if (!(FMSWifakErrorWhileSavingObj.solicitorDataSend_InDocumentDetails().getAttribute("prevvalue")
						.isBlank())) {
					break;
				}
			} catch (Exception e) {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.solicitorDataReceived_InDocumentDetails());
		...
		for (int i = 0; i <= 500; i++) {
			try {
				if (!(FMSWifakErrorWhileSavingObj.solicitorDataReceived_InDocumentDetails().getAttribute("prevvalue")
						.isBlank())) {
					break;
				}
			} catch (Exception e) {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.estimatorDateSent_InDocumentDetails());
		...
		for (int i = 0; i <= 500; i++) {
			try {
				if (!(FMSWifakErrorWhileSavingObj.estimatorDateSent_InDocumentDetails().getAttribute("prevvalue")
						.isBlank())) {
					break;
				}
			} catch (Exception e) {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.estimatorDateRecevied_InDocumentDetails());
		...
		for (int i = 0; i <= 500; i++) {
			try {
				if (!(FMSWifakErrorWhileSavingObj.estimatorDateRecevied_InDocumentDetails().getAttribute("prevvalue")
						.isBlank())) {
					break;
				}
			} catch (Exception e) {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.custodianDateSent_InDocumentDetails());
		...
		for (int i = 0; i <= 500; i++) {
			try {
				if (!(FMSWifakErrorWhileSavingObj.custodianDateSent_InDocumentDetails().getAttribute("prevvalue")
						.isBlank())) {
					break;
				}
			} catch (Exception e) {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.clicksolicitorDataSendRow2_InDocumentDetails());
		for (int i = 0; i < 2000; i++) {
			try {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.solicitorDataSendRow2_InDocumentDetails());
		...
		for (int i = 0; i <= 500; i++) {
			try {
				if (!(FMSWifakErrorWhileSavingObj.solicitorDataSendRow2_InDocumentDetails().getAttribute("prevvalue")
						.isBlank())) {
					break;
				}
			} catch (Exception e) {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.solicitorDataDataRecived2_InDocumentDetails());
		...
		for (int i = 0; i <= 500; i++) {
			try {
				if (!(FMSWifakErrorWhileSavingObj.solicitorDataDataRecived2_InDocumentDetails()
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.estimatorDateSent2_InDocumentDetails());
		...
		for (int i = 0; i <= 500; i++) {
			try {
				if (!(FMSWifakErrorWhileSavingObj.estimatorDateSent2_InDocumentDetails().getAttribute("prevvalue")
						.isBlank())) {
					break;
				}
			} catch (Exception e) {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.estimatorDateReceviedt2_InDocumentDetails());
		...
		for (int i = 0; i <= 500; i++) {
			try {
				if (!(FMSWifakErrorWhileSavingObj.estimatorDateReceviedt2_InDocumentDetails().getAttribute("prevvalue")
						.isBlank())) {
					break;
				}
			} catch (Exception e) {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.custodianDateSent2_InDocumentDetails());
		...
		for (int i = 0; i <= 500; i++) {
			try {
				if (!(FMSWifakErrorWhileSavingObj.custodianDateSent2_InDocumentDetails().getAttribute("prevvalue")
						.isBlank())) {
					break;
				}
			} catch (Exception e) {
	...
	public void save_the_details() {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.SaveButton_DocumentDetails_updateafter_Tab());
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.sendAlertPopup_facilityManagement());
		for (int i = 0; i < 2000; i++) {
			try {
	...
	public void user_click_facility_application_details_screen(Integer int1) {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.facilityApplicationDetails_InapprovelScreen());
		clicksAndActionsHelper
				.clickOnElement(FMSWifakErrorWhileSavingObj.facilityApplicationDetails_InapprovelScreen());
	...
	public void user_enter_cash_margin_value_in_facility_application_details(Integer int1) {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.cashMargin_InFacilityAppDetails_approvel_610());
	...
	public void user_click_approve_button_in_facility_application_detailsd(Integer int1) {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.approvelbutton_InFacilityAppDetails_610());
...
//  	        }
	...
	public void validate_the_facility_application_details_screen() {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.exceedFacilityAtSublimit_InapprovelScreen());
//	    	Assert.assertTrue(FMSWifakErrorWhileSavingObj.exceedFacilityAtSublimit_InapprovelScreen().isDisplayed());
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.subjectToFullRepayment_InapprovelScreen());
//	    	Assert.assertTrue(FMSWifakErrorWhileSavingObj.exceedFacilityAtSublimit_InapprovelScreen().isDisplayed());
	...
	public void validate_the_product_class_screen() {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.facilityLimitDetails_InapprovelScreen());
		...
		Assert.assertEquals("10",
				FMSWifakErrorWhileSavingObj.capRate_InLimitDetails_InUpdateApproveScreen().getAttribute("prevvalue"));

		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.sellingPrice_InLimitDetails_InUpdateApproveScreen());
		Assert.assertEquals("10", FMSWifakErrorWhileSavingObj.sellingPrice_InLimitDetails_InUpdateApproveScreen()
				.getAttribute("prevvalue"));
	...
	public void validate_the_document_details_screen() {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.solicitorDateSent_InapprovelScreen());
	...
	public void user_click_maintenance_in_draw_down_request_screen(Integer int1) {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.drawDownRequestMaintenance_Screen_610());
	...
	public void user_enter_facility_refercence_in_draw_down_request_screen(Integer int1) {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.facilityReference_drawDownMainInformation_610());
	...
	public void user_enter_drawdown_type_in_draw_down_request_screen(Integer int1) {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.drawdownType_drawDownMainInformation_610());
	...
	public void user_enter_description_english_in_draw_down_request_screen(Integer int1) {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.descriptionEnglish_drawDownMainInformation_610());
	...
	public void user_enter_description_arab_in_draw_down_request_screen(Integer int1) {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.descriptionArab_drawDownMainInformation_610());
	...
	public void user_enter_date_submitted_in_draw_down_request_screen(Integer int1) {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.dateDatesubmitted_drawDownMainInformation_610());
	...
	public void user_enter_date_value_date_in_draw_down_request_screen(Integer int1) {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.valueDatesubmitted_drawDownMainInformation_610());
	...
	public void user_click_drawdown_additional_details(Integer int1) {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.DrawdownAdditionalDetails_Screen_610());
...
//	    	Assert.assertEquals(true,FMSWifakErrorWhileSavingObj.FCAmount_DrawdownAdditionalDetails_Screen_610().getAttribute("prevvalue"));
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.FCAmount_DrawdownAdditionalDetails_Screen_610());
		String FCAmt = FMSWifakErrorWhileSavingObj.FCAmount_DrawdownAdditionalDetails_Screen_610()
				.getAttribute("prevvalue");
	...
	public void user_clicks_on_the_update_after_approve_menu_in_facility_type() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMSWifakErrorWhileSavingObj.facilityTypeUpdateAfterApprove_610());
	...
	public void user_enter_the_code_value_in_update_after_approve_menu() throws Throwable {
		...
		FMSWifakErrorWhileSavingObj.facilityTypeSearchCode_610().sendKeys("19", Keys.ENTER);
		// FMSWifakErrorWhileSavingObj.facilityTypeSearchCode_610().sendKeys(testData.get("Search
		// Code"),Keys.ENTER);
	}
	...
	public void user_double_click_on_the_retrieved_data_third_row_in_update_after_approve_menu(Integer int1) {
     waitHelper.waitForElementwithFluentwait(driver, FMSWifakErrorWhileSavingObj.facilityTypeSearchCodeResultRow3_610());
		
		for (int i = 0; i <= 300; i++) {
			try {
				clicksAndActionsHelper.doubleClick(FMSWifakErrorWhileSavingObj.facilityTypeSearchCodeResultRow3_610());
				break;
			} catch (Exception e) {
				if (i == 300) {
					Assert.fail(e.getMessage());
	...
	public void user_enter_the_code_value_in_approve_menu() throws Throwable {
		...
		// FMSWifakErrorWhileSavingObj.approveSearchCode_610().sendKeys(testData.get("Search
		// Code"),Keys.ENTER);
		FMSWifakErrorWhileSavingObj.approveSearchCode_610().sendKeys("19", Keys.ENTER);
	}
