...
import pageobjects.fms.FMS_WifakApplication_Obj;
...
public class FMS_WifakApplication_Steps {
	...
	ExcelData fmsTransactionsExcelData = new ExcelData(path, "FMS_WIFAK_Application_610", "DataSet ID");
...
//	}
	...
	public void user_610_enter_value_on_catagory() throws Throwable {
		// waitHelper.waitForElementwithFluentwait(driver,
...
//			}
	...
	public void user_610_enter_value_on_class() throws Throwable {
...
//				FMS_WifakApplication_Obj.getEnter_value_on_Catagory().click();
	...
	public void user_610_enter_value_on_vendor() throws Throwable {
	...
	public void user_610_enter_value_on_quantity() throws Throwable {
	...
	public void user_610_enter_value_on_unit() throws Throwable {
	...
	public void user_610_enter_value_on_cy() throws Throwable {
	...
	public void user_610_enter_value_on_unitcost() throws Throwable {
	...
	public void user_610_enter_value_on_vat_code() throws Throwable {
		for (int i = 0; i < 200; i++) {
			try {
	...
	public void user_610_enter_currency_button_in_account_no() throws Throwable {
...
//		FMS_WifakApplication_Obj.FRRValueDate_In_LimitsDetails().sendKeys("04/01/2021");
	...
	public void click_warning_popup_no_in_repayment_plan() throws Throwable {
		...
		clicksAndActionsHelper.moveToElement(FMS_WifakApplication_Obj.WaringButton_OnLimitDetails_Tab_610());
		clicksAndActionsHelper.clickOnElement(FMS_WifakApplication_Obj.WaringButton_OnLimitDetails_Tab_610());
		Thread.sleep(6000);
		// FMS_WifakApplication_Obj.No_Of_Payments_InRepaymentPlan_610().sendKeys("10");
	}
...
//---------------------approvel 1	    
	...
	public void user_retrive_the_first_data_in_approve_level2() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMS_WifakApplication_Obj.Enter_ValidateCode_approve_level2_610());
//	    	FMS_WifakApplication_Obj.approve1ClearBtn().click();
		...
		waitHelper.waitForElementwithFluentwait(driver,
				FMS_WifakApplication_Obj.ClickTheValue_ValidateCode_approve_level2_610());
	...
	public void user_retrive_the_first_data_in_approve_level3() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				FMS_WifakApplication_Obj.Enter_ValidateCode_approve_level3_610());
//	    	FMS_WifakApplication_Obj.approve1ClearBtn().click();
		FMS_WifakApplication_Obj.Enter_ValidateCode_approve_level3_610().sendKeys(SuccessMsg, Keys.ENTER);

		waitHelper.waitForElementwithFluentwait(driver,
				FMS_WifakApplication_Obj.ClickTheValue_ValidateCode_approve_level3_610());
