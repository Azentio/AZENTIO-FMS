...
public class FMSLogin {
	...
	ExcelData IISfmsParamLoginTestData = new ExcelData(TestDataPath, "IISFMSParam_login", "UserType");
	
	ExcelData IISfmsLoginTestData = new ExcelData(TestDataPath, "IISFMS_login", "UserType");
...
//		fmsCommonWebElements.fmsContinueButton().click();
	...
	public void loginIntoIISFmsParamApplication(String userType) {
		fmsLoginTestData = IISfmsParamLoginTestData.getTestdata(userType);
		fmsCommonWebElements = new FMSCommonWebElements(driver);
		clicksAndActionHelper = new ClicksAndActionsHelper(driver);
		waitHelper.waitForElementwithFluentwait(driver, fmsCommonWebElements.fmsUserName());
		fmsCommonWebElements.fmsUserName().click();
	...
	public void loginIntoIISFmsApplication(String userType) {
		fmsLoginTestData = IISfmsLoginTestData.getTestdata(userType);
		fmsCommonWebElements = new FMSCommonWebElements(driver);
		clicksAndActionHelper = new ClicksAndActionsHelper(driver);
		waitHelper.waitForElementwithFluentwait(driver, fmsCommonWebElements.fmsUserName());
		fmsCommonWebElements.fmsUserName().click();
