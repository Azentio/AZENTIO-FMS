...
///*********************************************************FMS_PARAMS*************************************************************///
    ...
    public void User_609_Select_Revolving_or_OneOff_Option_in_Facility_Type_Update_After_Approve_screen() throws Throwable {
    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.FacilityType_UpdateAfterApprove_RevolvingOneOff());
		clicksAndActionHelper.clickOnElement(FmsPageobjects_609.FacilityType_UpdateAfterApprove_RevolvingOneOff());
		dropdownhelper.SelectUsingVisibleText(FmsPageobjects_609.FacilityType_UpdateAfterApprove_RevolvingOneOff(), testData.get("RevolvingOneOff"));
    ...
    public void User_609_enable_the_apply_revolving_controls_in_main_details_tab() throws Throwable {
    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.FacilityType_UpdateAfterApprove_ApplyRevolvingControls());
    	clicksAndActionHelper.clickOnElement(FmsPageobjects_609.FacilityType_UpdateAfterApprove_ApplyRevolvingControls());
		try {
			if(FmsPageobjects_609.FacilityType_UpdateAfterApprove_ApplyRevolvingControls().isSelected()){
				clicksAndActionHelper.clickOnElement(FmsPageobjects_609.FacilityType_UpdateAfterApprove_ApplyRevolvingControls());
			}
			else {
				Assert.assertEquals(FmsPageobjects_609.FacilityType_UpdateAfterApprove_ApplyRevolvingControls().isSelected(), true);
			}
		} catch (Exception e) {
    ...
    @And("^User_609 Select the Code in Update After Approve Screen$")
   	public void User_609_select_the_code_in_update_after_approve_screen() throws Throwable {	
   		...
   		String xpath ="//table[@id='fmsFacilityTypeListGridTbl_Id_P008UP']/tbody/tr[2]/td[text()='"+testData.get("Code")+"']";
   		for (int i = 0; i < 200; i++) {
   			try {
	 ...
	 @And("^User_609 Click on the Facility Details Tab$")
	    ...
	    public void User_609_Enable_Mandatory_Customer_Grading_flag() throws Throwable {
	    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.STPFacilityRequirements_Mandatory_Customer_Grading());
	    ...
	    public void User_609_Enable_Credit_Authorization_flag() throws Throwable {
	    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.STPFacilityRequirements_CreditAuthorization());
	    ...
	    public void User_609_Enable_IssueFacilityOffer_flag() throws Throwable {
	    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.STPFacilityRequirements_IssueFacilityOffer());
	    ...
	    public void User_609_Enable_Document_Validation_flag() throws Throwable {
	    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.STPFacilityRequirements_DocumentValidation());
	    ...
	    public void User_609_Enable_Create_Active_Facility_If_Within_Limits_flag() throws Throwable {
	    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.STPFacilityRequirements_CreateActiveFacilityIfWithinLimits());
			clicksAndActionHelper.moveToElement(FmsPageobjects_609.STPFacilityRequirements_CreateActiveFacilityIfWithinLimits());
			WebElement CreateActiveFacilityIfWithinLimits = FmsPageobjects_609.STPFacilityRequirements_CreateActiveFacilityIfWithinLimits();
	    ...
	    public void User_609_Enable_Automatically_Approve_Facility_If_Within_Limits_flag() throws Throwable {
	    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.STPFacilityRequirements_AutomaticallyApproveFacilityIfWithinLimits());
			clicksAndActionHelper.moveToElement(FmsPageobjects_609.STPFacilityRequirements_AutomaticallyApproveFacilityIfWithinLimits());
			WebElement AutomaticallyApproveFacilityIfWithinLimits = FmsPageobjects_609.STPFacilityRequirements_AutomaticallyApproveFacilityIfWithinLimits();
	    ...
	    public void User_609_select_the_code_in_approve_screen() throws Throwable {
			...
			String xpath ="//table[@id='fmsFacilityTypeListGridTbl_Id_P008P']/tbody/tr[2]/td[text()='"+testData.get("Code")+"']";
			for (int i = 0; i < 200; i++) {
				try {
					WebElement Code  = driver.findElement(By.xpath(xpath));
					if (Code.isDisplayed()) {
...
///********************************************************Wifak Application********************************************************///
		...
		public void User_609_select_the_application_for_field_in_maintenance_screen() throws Throwable {
			...
			dropdownhelper.SelectUsingVisibleText(FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_Applicationfor(),testData.get("Application For"));
		...
		public void User_609_select_the_cif_no_in_main_information_tab() throws Throwable {
			...
			waitHelper.waitForElementwithFluentwait(driver,FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_Cifno());
		...
		public void User_609_select_the_facility_type_in_main_information_tab() throws Throwable {
			...
			waitHelper.waitForElementwithFluentwait(driver,FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_Facilitytype());
			clicksAndActionHelper.moveToElement(FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_Facilitytype());
			clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_Facilitytype());
			FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_Facilitytype().sendKeys(testData.get("Facility Type"));
		...
		public void User_609_select_the_country_of_financing_in_main_information_tab() throws Throwable {
			...
			for (int x = 0; x <= 200; x++) {
	            try {
	        		clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_CountryoffinancingSearch());
	                break;
	            } catch (Exception e) {
	                if (x==200) {
	                	 Assert.fail(e.getMessage());
			...
			clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_Countryoffinancing());
			FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_Countryoffinancing().sendKeys(testData.get("Country of Financing"));
		...
		public void User_609_select_the_facility_rating() throws Throwable {
			...
			waitHelper.waitForElementwithFluentwait(driver,FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_FacilityRating());
			clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_FacilityRating());
			FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_FacilityRating().sendKeys(testData.get("Facility Rating"));
		...
		public void User_609_select_the_currency_code() throws Throwable {
			...
			waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_AdditionalDetailsTab_CurrencyCode());
			clicksAndActionHelper.moveToElement(FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_AdditionalDetailsTab_CurrencyCode());
			clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_AdditionalDetailsTab_CurrencyCode());
			FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_AdditionalDetailsTab_CurrencyCode().sendKeys(testData.get("Currency Code"));
			FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_AdditionalDetailsTab_CurrencyCode().sendKeys(Keys.ENTER);
		...
		public void User_609_enter_the_total_value() throws Throwable {
			...
			FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_AdditionalDetailsTab_TotalValue().sendKeys(testData.get("Total value"));
			FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_AdditionalDetailsTab_TotalValue().sendKeys(Keys.TAB);
		}
		...
		public void User_609_select_the_offerexpiration() throws Throwable {
			...
			FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_AdditionalDetailsTab_OfferExpiration().sendKeys(testData.get("Expire Date"));
			FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_AdditionalDetailsTab_OfferExpiration().sendKeys(Keys.TAB);
		}
...
*/
		...
		public void User_609_select_the_product_class() throws Throwable {
			...
			waitHelper.waitForElementwithFluentwait(driver,FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_LimitDetailsTab_ProductClass());
			clicksAndActionHelper.moveToElement(FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_LimitDetailsTab_ProductClass());
			WebElement ProductClass = FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_LimitDetailsTab_ProductClass();
			ProductClass.click();
		...
		public void User_609_click_on_the_add_button() throws Throwable {
			...
			for (int i=0;i<200;i++) {
				try {
					clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_LimitDetailsTab_Add());
					break;
				} catch (Exception e) {
					if (i==199) {
						Assert.fail(e.getMessage());
		...
		public void User_609_select_the_solicitor_name() throws Throwable {
			...
			clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_DocumentDetailsTab_SolicitorName_Search());

			waitHelper.waitForElementwithFluentwait(driver,FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_DocumentDetailsTab_SolicitorName());
			clicksAndActionHelper.moveToElement(FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_DocumentDetailsTab_SolicitorName());
			WebElement ProductClass = FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_DocumentDetailsTab_SolicitorName();
			ProductClass.click();
		...
		public void User_609_select_the_estimator_name() throws Throwable {
			...
			waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_DocumentDetailsTab_EstimatorName());
			clicksAndActionHelper.moveToElement(FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_DocumentDetailsTab_EstimatorName());
			clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_DocumentDetailsTab_EstimatorName());
			FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_DocumentDetailsTab_EstimatorName().sendKeys(testData.get("Estimator Name"));
			FmsPageobjects_609.Applicationforfinancialfacilities_Maintenance_DocumentDetailsTab_EstimatorName().sendKeys(Keys.ENTER);
		...
		public void User_609_click_the_validate_button() {
		 ...
		 @And("^User_609 Click on the Approve level1 Screen$")
		    ...
		    public void User_609_Select_the_Code_in_Approve_level1() throws Throwable {
				...
				String xpath ="//table[@id='applicationFacilityGridTbl_Id_WIFT001AP1']/tbody/tr[2]/td[text()='"+"000000"+ApplicationNo+"']";
		    ...
		    public void User_609_Select_the_Code_in_Approve_level2() throws Throwable {	
				...
				String xpath ="//table[@id='applicationFacilityGridTbl_Id_WIFT001AP2']/tbody/tr[2]/td[text()='"+"000000"+ApplicationNo+"']";
		    ...
		    public void User_609_Select_the_Decision_in_Approve_level2() throws Throwable {
				...
				dropdownhelper.SelectUsingVisibleText(FmsPageobjects_609.WifakApplication_ApproveLevel2_Decision(), testData.get("Approve level2 Decision"));
		    }
		    ...
		    public void User_609_Click_on_Submit_in_Approve_Level2() throws Throwable {
			 ...
			 @And("^User_609 Click on the Approve level3 Screen$")
			    ...
			    public void User_609_Select_the_Code_in_Approve_level3() throws Throwable {
					...
					String xpath ="//table[@id='applicationFacilityGridTbl_Id_WIFT001AP3']/tbody/tr[2]/td[text()='"+"000000"+ApplicationNo+"']";
					for (int i = 0; i < 200; i++) {
						try {
							WebElement Code  = driver.findElement(By.xpath(xpath));
							if (Code.isDisplayed()) {
			    ...
			    public void User_609_Select_the_More_Decision_in_Approve_level3() throws Throwable {
			    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.WifakApplication_ApproveLevel3_MoreDecision());
					clicksAndActionHelper.clickOnElement(FmsPageobjects_609.WifakApplication_ApproveLevel3_MoreDecision());
					dropdownhelper.SelectUsingVisibleText(FmsPageobjects_609.WifakApplication_ApproveLevel3_MoreDecision(), testData.get("Approve level3 More Decision"));
			    }
...
//					String xpath ="//table[@id='facilityManagementGridTbl_Id_WIFT008MT']/tbody/tr/td[text()='"+"000000"+ApplicationNo+"']";
		...
		public void User_609_click_the_ok_button_to_proceed() {
			...
			try {
				if (FmsPageobjects_609.Confirmok().isDisplayed()) {
					FmsPageobjects_609.Confirmok().click();
				}
			} catch (Exception e) {
				Assert.fail(e.getMessage());
			}
		...
		public void User_609_click_dismiss_in_send_alert() {
			...
			try {
				if (FmsPageobjects_609.SendAlert().isDisplayed()) {
					FmsPageobjects_609.SendAlert().click();
				}
			} catch (Exception e) {
				Assert.fail(e.getMessage());
			}
	...
	*/
		...
		public void User_609_Click_on_Approval_Committee_Recommendations_in_Wifak_Application() throws Throwable {
			waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.WifakApplication_ApprovalCommitteeRecommendations());
		...
		public void User_609_Select_the_Code_in_Approval_Committee_Recommendations() throws Throwable {
			waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.WifakApplication_ApprovalCommitteeRecommendations_Code());
			clicksAndActionHelper.clickOnElement(FmsPageobjects_609.WifakApplication_ApprovalCommitteeRecommendations_Code());
			System.out.println("ApplicationNo  :"+ApplicationNo);
			
			FmsPageobjects_609.WifakApplication_ApprovalCommitteeRecommendations_Code().sendKeys(ApplicationNo,Keys.ENTER);
			
			String xpath ="//table[@id='applicationFacilityGridTbl_Id_WIFT002MT']/tbody/tr[2]/td[text()='"+"000000"+ApplicationNo+"']";
			for (int i = 0; i < 200; i++) {
				try {
					WebElement Code  = driver.findElement(By.xpath(xpath));
					if (Code.isDisplayed()) {
		...
		public void User_609_Click_Recommend_button_in_Approval_Committee_Recommendations() throws Throwable {
			waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.WifakApplication_ApprovalCommitteeRecommendations_Recommend());
			clicksAndActionHelper.clickOnElement(FmsPageobjects_609.WifakApplication_ApprovalCommitteeRecommendations_Recommend());
		}
		...
		public void User_609_Select_the_decision_in_Approval_Committee_Recommendations() throws Throwable {
			...
			waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.ApprovalCommitteesRecommendation_Popup_609());
			String RecommendedBy = "(//table[@id='ApplicationFacilityRecommendationGrid_WIFT002MT']//td[text()='"+User.get("UserName")+"'])[1]";
			for(int  i= 0 ; i<500;i++) {
				try {
		...
		public void User_609_Validate_the_Committee_Recommendation_is_Enabled() throws Throwable {
			waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.WifakApplication_ApprovalCommitteeRecommendations_Recommend_Recommendation());
			Assert.assertEquals(FmsPageobjects_609.WifakApplication_ApprovalCommitteeRecommendations_Recommend_Recommendation().isEnabled(), true);
		...
		public void User_609_Click_on_Ok_in_Approval_Committee_Recommendations() throws Throwable {
			waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.WifakApplication_ApprovalCommitteeRecommendations_Recommend_Recommendation_Ok());
			clicksAndActionHelper.clickOnElement(FmsPageobjects_609.WifakApplication_ApprovalCommitteeRecommendations_Recommend_Recommendation_Ok());
		}
...
///****************************************************Grading**********************************************************************///
		...
		public void User_609_Select_the_Application_Refernece_in_Grading() throws Throwable {
			waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.WifakApplication_Grading_Maintenance_SearchCode_609());
			clicksAndActionHelper.clickOnElement(FmsPageobjects_609.WifakApplication_Grading_Maintenance_SearchCode_609());
			
			waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.WifakApplication_Grading_Maintenance_Code_609());
			...
			String xpath ="//table[@id='gridtab_Application_Ref_WIFT003MT']/tbody/tr[2]/td[text()='"+"000000"+ApplicationNo+"']";
			for (int i = 0; i < 200; i++) {
				try {
					WebElement Code  = driver.findElement(By.xpath(xpath));
					if (Code.isDisplayed()) {
		...
		public void User_609_Click_on_Save_Button_in_Grading () throws Throwable {
			waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.WifakApplication_Grading_Maintenance_Save_609());
		...
		public void User_609_Click_on_Approve_in_Approve_screen_in_Grading() throws Throwable {
			waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.WifakApplication_Grading_Approve_ApproveButton_609());
...
//		}
	    ...
	    public void User_609_click_on_the_request_financing_submenu_in_request() throws Throwable {
		 ...
		 @And("^User_609 Click on the Request For Financing under Request Financing submenu in Request$")
		    public void User_609_click_on_the_request_for_financing_under_Request_Financing_submenu_in_request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_609());
		    ...
		    public void User_609_click_on_the_maintenance_screen_in_request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_609());
				clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_609());
		    }
		    ...
		    public void User_609_select_the_reason_for_submission_fieldin_request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_ReasonForSubmission_609());
				dropdownhelper.SelectUsingVisibleText(FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_ReasonForSubmission_609(),testData.get("Application For"));
		    }
		    ...
		    public void User_609_Select_the_Customer_field_in_request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Customer_Search_609());
				clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Customer_Search_609());
				
				waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Customer_609());
				WebElement Customer = FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Customer_609();
				Customer.click();
				Customer.sendKeys(testData.get("CIF No"),Keys.ENTER);
				
				String xpath ="//table[@id='gridtab_requestFinanacingCif_RFFRF00MT']/tbody/tr/td[text()='"+testData.get("CIF No")+"']";
				for (int i = 0; i < 200; i++) {
					try {
						WebElement Code  = driver.findElement(By.xpath(xpath));
						if (Code.isDisplayed()) {
		    ...
		    public void User_609_Select_the_Facility_Type_in_request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_FacilityTypeSearch_609());
		    	FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_FacilityTypeSearch_609().click();
		    	
				waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_FacilityType_609());
				WebElement FacilityType = FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_FacilityType_609();
				FacilityType.click();
				
				FacilityType.sendKeys(testData.get("Facility Type"),Keys.ENTER);
				//table[@id='gridtab_requestFinancingFacilityType_RFFRF00MT']/tbody/tr/td[text()='19']
				String xpath ="//table[@id='gridtab_requestFinancingFacilityType_RFFRF00MT']/tbody/tr/td[text()='"+testData.get("Facility Type")+"']";
				for (int i = 0; i < 200; i++) {
					try {
						WebElement Code  = driver.findElement(By.xpath(xpath));
						if (Code.isDisplayed()) {
		    ...
		    public void User_609_Enter_the_Total_Limit_in_request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_TotalLimit_609());
				WebElement TotalLimit = FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_TotalLimit_609();
				TotalLimit.sendKeys(testData.get("Total value"),Keys.TAB);
		    }
		    ...
		    public void User_609_Select_the_Customer_Account_in_Request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_CustomerAccount_609());
				clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_CustomerAccount_609());
				
				waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_CustomerAccount_GL_609());
				clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_CustomerAccount_GL_609());
				FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_CustomerAccount_GL_609().sendKeys("GL",Keys.ENTER);
		    ...
		    public void User_609_Click_on_the_Disbursement_or_Sublimit_tab_in_request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_609());
				clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_609());
		    }
		    ...
		    public void User_609_Click_on_Add_icon_in_Disbursement_or_sublimit_tab_in_request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_Addicon_609());
				WebElement AddIcon = FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_Addicon_609();
		    	try {
					for(int i= 0;i<=200;i++) {
						if (AddIcon.isDisplayed()) {
							AddIcon.click();
		    ...
		    public void User_609_Select_the_Item_in_Request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_Item_609());
		    	FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_Item_609().click();
				dropdownhelper.SelectUsingVisibleText(FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_Item_609(),testData.get("Item"));
		    }
		    ...
		    public void User_609_Select_the_product_Class_in_Request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_ProductClassSearch_609());
		    	FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_ProductClassSearch_609().click();
		    	
				waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_ProductClass_609());
				WebElement FacilityType = FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_ProductClass_609();
				FacilityType.click();
				
				FacilityType.sendKeys(testData.get("Product Class"),Keys.ENTER);
				String xpath ="//table[@id='gridtab_requestFinancingLimitDetailsGeneralFacilityProductClass_RFFRF00MT']/tbody/tr/td[text()='"+testData.get("Product Class")+"']";
				for (int i = 0; i < 200; i++) {
					try {
						WebElement Code  = driver.findElement(By.xpath(xpath));
						if (Code.isDisplayed()) {
		    ...
		    public void User_609_Click_on_Fees_or_Charges_label_in_Request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_FeesCharges_609());
				clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_FeesCharges_609());
		    ...
		    public void User_609_Click_and_Select_the_Charges_in_Request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_FeesCharges_Select_609());
				clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_FeesCharges_Select_609());
				
				waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_FeesCharges_CollectAtFacilityApproval_609());
				clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_FeesCharges_CollectAtFacilityApproval_609());
				
				waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_FeesCharges_Ok_609());
				clicksAndActionHelper.clickOnElement(FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_FeesCharges_Ok_609());
		    ...
		    public void User_609_Select_the_type_in_Request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_TypeSearch_609());
		    	FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_TypeSearch_609().click();
		    	
				waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_Type_609());
				WebElement FacilityType = FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_Type_609();
				FacilityType.click();
		    ...
		    public void User_609_Enter_the_New_margin_value_in_request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_NewMargin_609());
				WebElement NewMargin = FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_NewMargin_609();
		    	NewMargin.click();
		    	NewMargin.clear();
		    	NewMargin.sendKeys(testData.get("Margin Rate"),Keys.TAB);
		    ...
		    public void User_609_Enable_Clean_flag_in_Product_Class_in_request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_Clean_609());
		    	WebElement Clean = FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_Clean_609();
		    	try {
					if (Clean.isSelected()) {
						Assert.assertTrue(true);
					}
		    ...
		    public void User_609_Enter_Values_in_Tenure_in_Request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_Tenure_609());
				...
				FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_Tenure_609().sendKeys(testData.get("Tenure"),Keys.TAB);
		    }
		    ...
		    public void User_609_Click_on_Add_in_Product_Class_in_request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Maintenance_Sublimit_Add_609());
		    ...
		    public void User_609_Click_the_Save_Button_in_Request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Save_609());
		    ...
		    public void User_609_Click_the_Validate_Button_in_Request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_RequestForFinancing_Validate_609());
		    ...
		    public void User_609_Select_the_Code_in_Approve_Level1_in_Request() {
				...
				String xpath ="//table[@id='requestFinancingGridTbl_Id_RFFRF00P1']/tbody/tr[2]/td[text()='"+"000000"+ApplicationNo+"']";
				for (int i = 0; i < 200; i++) {
					try {
						WebElement Code  = driver.findElement(By.xpath(xpath));
						if (Code.isDisplayed()) {
		    ...
		    public void User_609_Select_the_Code_in_Credit_Review_screen_in_Request() {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_CreditReview_Code_609());
				...
				String xpath ="//table[@id='requestFinancingGridTbl_Id_RFFRF00CV']/tbody/tr/td[text()='"+"000000"+ApplicationCode+"']";
				for (int i = 0; i < 200; i++) {
					try {
						WebElement Code  = driver.findElement(By.xpath(xpath));
						if (Code.isDisplayed()) {
		    ...
		    public void User_609_Click_on_Credit_Committee_Recommendations_tab_in_Request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_CreditReview_CreditCommitteeRecommendations_609());
		    ...
		    public void User_609_Click_on_Recommendations_Dropdown_in_Request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_CreditReview_CreditCommitteeRecommendations_Recommendations_609());
				FmsPageobjects_609.Request_RequestFinancing_CreditReview_CreditCommitteeRecommendations_Recommendations_609().click();
		    }
		    ...
		    public void User_609_Click_on_Credit_Review_Button_in_Request() throws Throwable {
		    	waitHelper.waitForElementwithFluentwait(driver, FmsPageobjects_609.Request_RequestFinancing_CreditReviewBtton_609());
